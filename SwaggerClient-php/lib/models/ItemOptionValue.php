...
class ItemOptionValue implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getAdditionalDimensionApplicationAllowableValues();
    ...
    {
        $allowed_values = $this->getAdditionalDimensionApplicationAllowableValues();
        if (!is_null($additional_dimension_application) && !in_array($additional_dimension_application, $allowed_values)) {
