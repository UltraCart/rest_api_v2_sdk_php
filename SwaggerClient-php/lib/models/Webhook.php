...
class Webhook implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getApiVersionAllowableValues();
        ...
        $allowed_values = $this->getAuthenticationTypeAllowableValues();
    ...
    {
        $allowed_values = $this->getApiVersionAllowableValues();
        if (!is_null($api_version) && !in_array($api_version, $allowed_values)) {
