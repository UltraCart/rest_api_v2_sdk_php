...
class OrderPaymentECheck implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getBankAccountTypeAllowableValues();
        ...
        $allowed_values = $this->getBankOwnerTypeAllowableValues();
    ...
    {
        $allowed_values = $this->getBankAccountTypeAllowableValues();
        if (!is_null($bank_account_type) && !in_array($bank_account_type, $allowed_values)) {
    ...
    {
        $allowed_values = $this->getBankOwnerTypeAllowableValues();
        if (!is_null($bank_owner_type) && !in_array($bank_owner_type, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'bank_owner_type', must be one of '%s'",
                    implode("', '", $allowed_values)
