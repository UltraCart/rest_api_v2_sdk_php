 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CartShipping implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['postal_code']) && (strlen($this->container['postal_code']) > 25)) {
            $invalid_properties[] = "invalid value for 'postal_code', the character length must be smaller than or equal to 25.";
        }
        ...
        if (!is_null($this->container['shipping_method']) && (strlen($this->container['shipping_method']) > 40)) {
            $invalid_properties[] = "invalid value for 'shipping_method', the character length must be smaller than or equal to 40.";
        }

        if (!is_null($this->container['special_instructions']) && (strlen($this->container['special_instructions']) > 10000)) {
            $invalid_properties[] = "invalid value for 'special_instructions', the character length must be smaller than or equal to 10000.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['postal_code']) > 25) {
            return false;
        }
        if (strlen($this->container['shipping_3rd_party_account_number']) > 20) {
            return false;
        }
        if (strlen($this->container['shipping_method']) > 40) {
            return false;
        }
        if (strlen($this->container['special_instructions']) > 10000) {
            return false;
        }
    ...
    {
        if (!is_null($postal_code) && (strlen($postal_code) > 25)) {
    ...
    {
        if (!is_null($shipping_3rd_party_account_number) && (strlen($shipping_3rd_party_account_number) > 20)) {
    ...
    {
        if (!is_null($shipping_method) && (strlen($shipping_method) > 40)) {
    ...
    {
        if (!is_null($special_instructions) && (strlen($special_instructions) > 10000)) {
