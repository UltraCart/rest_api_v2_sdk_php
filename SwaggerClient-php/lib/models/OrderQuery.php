 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OrderQuery implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cc_email']) && (strlen($this->container['cc_email']) > 100)) {
            $invalid_properties[] = "invalid value for 'cc_email', the character length must be smaller than or equal to 100.";
        }
        ...
        $allowed_values = $this->getPaymentMethodAllowableValues();
        ...
        if (!is_null($this->container['phone']) && (strlen($this->container['phone']) > 25)) {
            $invalid_properties[] = "invalid value for 'phone', the character length must be smaller than or equal to 25.";
        }
    ...
    {
        $allowed_values = $this->getPaymentMethodAllowableValues();
        if (!is_null($payment_method) && !in_array($payment_method, $allowed_values)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'payment_method', must be one of '%s'",
                    implode("', '", $allowed_values)
