 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ItemShippingMethod implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['shipping_method_validity'], $allowedValues)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'shipping_method_validity', must be one of '%s'",
    ...
    {
        $allowedValues = $this->getShippingMethodValidityAllowableValues();
        if (!is_null($shipping_method_validity) && !in_array($shipping_method_validity, $allowedValues)) {
