 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ChargebackDispute implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_number']) && (strlen($this->container['account_number']) > 50)) {
            $invalid_properties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['auth_code']) && (strlen($this->container['auth_code']) > 20)) {
            $invalid_properties[] = "invalid value for 'auth_code', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['case_number']) && (strlen($this->container['case_number']) > 50)) {
            $invalid_properties[] = "invalid value for 'case_number', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['currency']) && (strlen($this->container['currency']) > 10)) {
            $invalid_properties[] = "invalid value for 'currency', the character length must be smaller than or equal to 10.";
        }

        if (!is_null($this->container['encryption_key']) && (strlen($this->container['encryption_key']) > 100)) {
            $invalid_properties[] = "invalid value for 'encryption_key', the character length must be smaller than or equal to 100.";
        }

        if (!is_null($this->container['fax_failure_reason']) && (strlen($this->container['fax_failure_reason']) > 250)) {
            $invalid_properties[] = "invalid value for 'fax_failure_reason', the character length must be smaller than or equal to 250.";
        }
        ...
        if (!is_null($this->container['icsid']) && (strlen($this->container['icsid']) > 50)) {
            $invalid_properties[] = "invalid value for 'icsid', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['order_id']) && (strlen($this->container['order_id']) > 30)) {
            $invalid_properties[] = "invalid value for 'order_id', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['partial_card_number']) && (strlen($this->container['partial_card_number']) > 20)) {
            $invalid_properties[] = "invalid value for 'partial_card_number', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['pdf_file_oid']) && (strlen($this->container['pdf_file_oid']) > 32)) {
            $invalid_properties[] = "invalid value for 'pdf_file_oid', the character length must be smaller than or equal to 32.";
        }

        if (!is_null($this->container['reason_code']) && (strlen($this->container['reason_code']) > 70)) {
            $invalid_properties[] = "invalid value for 'reason_code', the character length must be smaller than or equal to 70.";
        }

        if (!is_null($this->container['status']) && (strlen($this->container['status']) > 20)) {
            $invalid_properties[] = "invalid value for 'status', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['website_url']) && (strlen($this->container['website_url']) > 250)) {
            $invalid_properties[] = "invalid value for 'website_url', the character length must be smaller than or equal to 250.";
        }
    ...
    {
        if (strlen($fax_failure_reason) > 250) {
    ...
    {
        if (strlen($partial_card_number) > 20) {
