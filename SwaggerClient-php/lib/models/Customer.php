...
class Customer implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['business_notes']) && (strlen($this->container['business_notes']) > 2000)) {
            $invalid_properties[] = "invalid value for 'business_notes', the character length must be smaller than or equal to 2000.";
        }

        if (!is_null($this->container['dhl_account_number']) && (strlen($this->container['dhl_account_number']) > 20)) {
            $invalid_properties[] = "invalid value for 'dhl_account_number', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['fedex_account_number']) && (strlen($this->container['fedex_account_number']) > 20)) {
            $invalid_properties[] = "invalid value for 'fedex_account_number', the character length must be smaller than or equal to 20.";
        }
        ...
        if (!is_null($this->container['referral_source']) && (strlen($this->container['referral_source']) > 50)) {
            $invalid_properties[] = "invalid value for 'referral_source', the character length must be smaller than or equal to 50.";
        }
        ...
        if (!is_null($this->container['tax_id']) && (strlen($this->container['tax_id']) > 15)) {
            $invalid_properties[] = "invalid value for 'tax_id', the character length must be smaller than or equal to 15.";
        }

        if (!is_null($this->container['ups_account_number']) && (strlen($this->container['ups_account_number']) > 20)) {
            $invalid_properties[] = "invalid value for 'ups_account_number', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['website_url']) && (strlen($this->container['website_url']) > 100)) {
            $invalid_properties[] = "invalid value for 'website_url', the character length must be smaller than or equal to 100.";
        }
    ...
    {
        if (strlen($dhl_account_number) > 20) {
    ...
    {
        if (strlen($fedex_account_number) > 20) {
    ...
    {
        if (strlen($last_modified_by) > 100) {
    ...
    {
        if (strlen($ups_account_number) > 20) {
