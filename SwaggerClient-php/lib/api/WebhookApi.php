...
class WebhookApi
{
    ...
    {
        return $this->deleteWebhookAsyncWithHttpInfo($webhook_oid)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function deleteWebhookRequest($webhook_oid)
    {
        ...
        // path params
        if ($webhook_oid !== null) {
            $resourcePath = str_replace('{' . 'webhookOid' . '}', ObjectSerializer::toPathValue($webhook_oid), $resourcePath);
        }
    ...
    public function getWebhookLogWithHttpInfo($webhook_oid, $request_id)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\WebhookLogResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getWebhookLogAsyncWithHttpInfo($webhook_oid, $request_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getWebhookLogRequest($webhook_oid, $request_id)
    {
        ...
        // path params
        if ($request_id !== null) {
            $resourcePath = str_replace('{' . 'requestId' . '}', ObjectSerializer::toPathValue($request_id), $resourcePath);
        }
    ...
    public function getWebhookLogSummariesWithHttpInfo($webhook_oid, $_limit = '100', $_offset = '0', $_since = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\WebhookLogSummariesResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getWebhookLogSummariesAsyncWithHttpInfo($webhook_oid, $_limit, $_offset, $_since)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getWebhooksWithHttpInfo($_limit = '100', $_offset = '0', $_sort = null, $_placeholders = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\WebhooksResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getWebhooksAsyncWithHttpInfo($_limit, $_offset, $_sort, $_placeholders)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function insertWebhookWithHttpInfo($webhook, $_placeholders = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\WebhookResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->insertWebhookAsyncWithHttpInfo($webhook, $_placeholders)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function resendEventWithHttpInfo($webhook_oid, $event_name)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\WebhookSampleRequestResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->resendEventAsyncWithHttpInfo($webhook_oid, $event_name)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function resendEventRequest($webhook_oid, $event_name)
    {
        ...
        // path params
        if ($event_name !== null) {
            $resourcePath = str_replace('{' . 'eventName' . '}', ObjectSerializer::toPathValue($event_name), $resourcePath);
        }
    ...
    {
        return $this->updateWebhookAsyncWithHttpInfo($webhook, $webhook_oid, $_placeholders)->then(function ($response) {
            return $response[0];
        });
    }
