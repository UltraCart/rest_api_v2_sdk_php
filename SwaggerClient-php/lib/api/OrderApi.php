...
class OrderApi
{
    ...
    public function cancelOrderWithHttpInfo($order_id)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\BaseResponse', $e->getResponseHeaders());
    ...
    {
        return $this->cancelOrderAsyncWithHttpInfo($order_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getOrderWithHttpInfo($order_id, $_expand = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\OrderResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getOrderAsyncWithHttpInfo($order_id, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->getOrdersByQueryAsyncWithHttpInfo($order_query, $_limit, $_offset, $_sort, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->resendReceiptAsyncWithHttpInfo($order_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->resendShipmentConfirmationAsyncWithHttpInfo($order_id)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->updateOrderAsyncWithHttpInfo($order, $order_id, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
