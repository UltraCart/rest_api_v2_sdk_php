...
class FulfillmentApi
{
    ...
    {
        return $this->acknowledgeOrdersAsyncWithHttpInfo($distribution_center_code, $order_ids)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function acknowledgeOrdersRequest($distribution_center_code, $order_ids)
    {
        ...
        if ($distribution_center_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $distribution_center_code when calling acknowledgeOrders');
        }
        // verify the required parameter 'order_ids' is set
        if ($order_ids === null) {
            throw new \InvalidArgumentException('Missing the required parameter $order_ids when calling acknowledgeOrders');
        }
        ...
        // path params
        if ($distribution_center_code !== null) {
            $resourcePath = str_replace('{' . 'distribution_center_code' . '}', ObjectSerializer::toPathValue($distribution_center_code), $resourcePath);
        }
    ...
    public function getDistributionCenterOrdersWithHttpInfo($distribution_center_code)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\OrdersResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getDistributionCenterOrdersAsyncWithHttpInfo($distribution_center_code)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getDistributionCenterOrdersRequest($distribution_center_code)
    {
        // verify the required parameter 'distribution_center_code' is set
        if ($distribution_center_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $distribution_center_code when calling getDistributionCenterOrders');
        }
    ...
    public function getDistributionCentersWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\DistributionCentersResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getDistributionCentersAsyncWithHttpInfo()->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->shipOrdersAsyncWithHttpInfo($distribution_center_code, $shipments)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function shipOrdersRequest($distribution_center_code, $shipments)
    {
        // verify the required parameter 'distribution_center_code' is set
        if ($distribution_center_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $distribution_center_code when calling shipOrders');
        }
        // verify the required parameter 'shipments' is set
        if ($shipments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $shipments when calling shipOrders');
        }
    ...
    {
        return $this->updateInventoryAsyncWithHttpInfo($distribution_center_code, $inventories)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function updateInventoryRequest($distribution_center_code, $inventories)
    {
        // verify the required parameter 'distribution_center_code' is set
        if ($distribution_center_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $distribution_center_code when calling updateInventory');
        }
        // verify the required parameter 'inventories' is set
        if ($inventories === null) {
            throw new \InvalidArgumentException('Missing the required parameter $inventories when calling updateInventory');
        }
