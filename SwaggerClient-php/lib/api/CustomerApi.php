...
class CustomerApi
{
    ...
    public function deleteCustomerWithHttpInfo($customer_profile_oid)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\CustomerResponse', $e->getResponseHeaders());
    ...
    {
        return $this->deleteCustomerAsyncWithHttpInfo($customer_profile_oid)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function deleteCustomerRequest($customer_profile_oid)
    {
        ...
        // path params
        if ($customer_profile_oid !== null) {
            $resourcePath = str_replace('{' . 'customer_profile_oid' . '}', ObjectSerializer::toPathValue($customer_profile_oid), $resourcePath);
        }
    ...
    {
        return $this->getCustomerAsyncWithHttpInfo($customer_profile_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getCustomersWithHttpInfo($email = null, $qb_class = null, $quickbooks_code = null, $last_modified_dts_start = null, $last_modified_dts_end = null, $signup_dts_start = null, $signup_dts_end = null, $billing_first_name = null, $billing_last_name = null, $billing_company = null, $billing_city = null, $billing_state = null, $billing_postal_code = null, $billing_country_code = null, $billing_day_phone = null, $billing_evening_phone = null, $shipping_first_name = null, $shipping_last_name = null, $shipping_company = null, $shipping_city = null, $shipping_state = null, $shipping_postal_code = null, $shipping_country_code = null, $shipping_day_phone = null, $shipping_evening_phone = null, $pricing_tier_oid = null, $pricing_tier_name = null, $_limit = '100', $_offset = '0', $_since = null, $_sort = null, $_expand = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\CustomersResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getCustomersAsyncWithHttpInfo($email, $qb_class, $quickbooks_code, $last_modified_dts_start, $last_modified_dts_end, $signup_dts_start, $signup_dts_end, $billing_first_name, $billing_last_name, $billing_company, $billing_city, $billing_state, $billing_postal_code, $billing_country_code, $billing_day_phone, $billing_evening_phone, $shipping_first_name, $shipping_last_name, $shipping_company, $shipping_city, $shipping_state, $shipping_postal_code, $shipping_country_code, $shipping_day_phone, $shipping_evening_phone, $pricing_tier_oid, $pricing_tier_name, $_limit, $_offset, $_since, $_sort, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->insertCustomerAsyncWithHttpInfo($customer, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->updateCustomerAsyncWithHttpInfo($customer, $customer_profile_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
