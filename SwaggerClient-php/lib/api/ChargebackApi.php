...
class ChargebackApi
{
    ...
    public function deleteChargebackWithHttpInfo($chargeback_dispute_oid)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ChargebackDisputeResponse', $e->getResponseHeaders());
    ...
    {
        return $this->deleteChargebackAsyncWithHttpInfo($chargeback_dispute_oid)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function deleteChargebackRequest($chargeback_dispute_oid)
    {
        ...
        // path params
        if ($chargeback_dispute_oid !== null) {
            $resourcePath = str_replace('{' . 'chargeback_dispute_oid' . '}', ObjectSerializer::toPathValue($chargeback_dispute_oid), $resourcePath);
        }
    ...
    {
        return $this->getChargebackDisputeAsyncWithHttpInfo($chargeback_dispute_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function getChargebackDisputesWithHttpInfo($order_id = null, $case_number = null, $status = null, $expiration_dts_start = null, $expiration_dts_end = null, $chargeback_dts_start = null, $chargeback_dts_end = null, $_limit = '100', $_offset = '0', $_since = null, $_sort = null, $_expand = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ChargebackDisputesResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getChargebackDisputesAsyncWithHttpInfo($order_id, $case_number, $status, $expiration_dts_start, $expiration_dts_end, $chargeback_dts_start, $chargeback_dts_end, $_limit, $_offset, $_since, $_sort, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->insertChargebackAsyncWithHttpInfo($chargeback, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    {
        return $this->updateChargebackAsyncWithHttpInfo($chargeback, $chargeback_dispute_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
