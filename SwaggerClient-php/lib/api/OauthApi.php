...
class OauthApi
{
    ...
    public function oauthAccessTokenWithHttpInfo($client_id, $grant_type, $code = null, $redirect_uri = null, $refresh_token = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\OauthTokenResponse', $e->getResponseHeaders());
    ...
    {
        return $this->oauthAccessTokenAsyncWithHttpInfo($client_id, $grant_type, $code, $redirect_uri, $refresh_token)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    public function oauthRevokeWithHttpInfo($client_id, $token)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\OauthRevokeSuccessResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->oauthRevokeAsyncWithHttpInfo($client_id, $token)->then(function ($response) {
            return $response[0];
        });
    }
