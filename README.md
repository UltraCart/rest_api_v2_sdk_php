...
{
  "require": {
    "ultracart/rest_api_v2_sdk_php": "4.1.172"
  }
}
```
...
*AutoOrderApi* | [**attemptAutoOrderRebill**](docs/Api/AutoOrderApi.md#attemptautoorderrebill) | **POST** /auto_order/auto_orders/{auto_order_oid}/rebill | Attempt a failed rebill on an auto order
...
*AutoOrderApi* | [**updateAutoOrderPayment**](docs/Api/AutoOrderApi.md#updateautoorderpayment) | **PUT** /auto_order/auto_orders/{auto_order_oid}/payment | Update the payment information on an auto order
...
*BulkApi* | [**bulkCancelJob**](docs/Api/BulkApi.md#bulkcanceljob) | **DELETE** /bulk/{object}/{job_id} | Request cancellation of a bulk job
*BulkApi* | [**bulkGenerateUploadUrl**](docs/Api/BulkApi.md#bulkgenerateuploadurl) | **POST** /bulk/{object}/upload-url | Generate a presigned upload URL for a bulk payload
*BulkApi* | [**bulkGetJob**](docs/Api/BulkApi.md#bulkgetjob) | **GET** /bulk/{object}/{job_id} | Retrieve a bulk job&#39;s status and counts
*BulkApi* | [**bulkGetJobRecords**](docs/Api/BulkApi.md#bulkgetjobrecords) | **GET** /bulk/{object}/{job_id}/records | Paginate a bulk job&#39;s per-record results
*BulkApi* | [**bulkListJobs**](docs/Api/BulkApi.md#bulklistjobs) | **GET** /bulk/{object} | List bulk jobs for the calling merchant
*BulkApi* | [**bulkSubmitJob**](docs/Api/BulkApi.md#bulksubmitjob) | **POST** /bulk/{object} | Submit a bulk job
...
*ConversationApi* | [**deleteAgentStatusConfig**](docs/Api/ConversationApi.md#deleteagentstatusconfig) | **DELETE** /conversation/agent/status/config/{conversation_status_uuid} | Soft-deactivate a custom agent status
...
*ConversationApi* | [**deletePbxClassOfService**](docs/Api/ConversationApi.md#deletepbxclassofservice) | **DELETE** /conversation/pbx/class_of_service/{classOfServiceUuid} | Delete pbx class of service
*ConversationApi* | [**deletePbxHardwarePhone**](docs/Api/ConversationApi.md#deletepbxhardwarephone) | **DELETE** /conversation/pbx/hardware_phone/{conversationPbxHardwarePhoneUuid} | Delete pbx hardware phone
...
*ConversationApi* | [**deleteUserPbxAudio**](docs/Api/ConversationApi.md#deleteuserpbxaudio) | **DELETE** /conversation/pbx/audio/user/{conversationPbxAudioUuid} | Delete user pbx audio
...
*ConversationApi* | [**getAgentStatusConfigs**](docs/Api/ConversationApi.md#getagentstatusconfigs) | **GET** /conversation/agent/status/config | List custom agent statuses
*ConversationApi* | [**getAgentStatusHeatmap**](docs/Api/ConversationApi.md#getagentstatusheatmap) | **POST** /conversation/agent/status/heatmap | Agent x hour-of-day heatmap
*ConversationApi* | [**getAgentStatusSummary**](docs/Api/ConversationApi.md#getagentstatussummary) | **GET** /conversation/agent/status/rollup/summary | Dashboard summary for a date range
*ConversationApi* | [**getAgentStatusTimeline**](docs/Api/ConversationApi.md#getagentstatustimeline) | **GET** /conversation/agent/status/history/{agent_user_id}/timeline | Day timeline for a single agent
...
*ConversationApi* | [**getPbxCall**](docs/Api/ConversationApi.md#getpbxcall) | **GET** /conversation/pbx/call/{callUuid} | Get pbx call record
*ConversationApi* | [**getPbxClassOfService**](docs/Api/ConversationApi.md#getpbxclassofservice) | **GET** /conversation/pbx/class_of_service/{classOfServiceUuid} | Get pbx class of service
*ConversationApi* | [**getPbxClassesOfService**](docs/Api/ConversationApi.md#getpbxclassesofservice) | **GET** /conversation/pbx/class_of_service | Get pbx classes of service
*ConversationApi* | [**getPbxCosAuditLogs**](docs/Api/ConversationApi.md#getpbxcosauditlogs) | **GET** /conversation/pbx/class_of_service/audit_log | Get pbx class of service audit logs
*ConversationApi* | [**getPbxDefaultTimezone**](docs/Api/ConversationApi.md#getpbxdefaulttimezone) | **GET** /conversation/pbx/config/default-timezone | Get the merchant default timezone
*ConversationApi* | [**getPbxHardwarePhone**](docs/Api/ConversationApi.md#getpbxhardwarephone) | **GET** /conversation/pbx/hardware_phone/{conversationPbxHardwarePhoneUuid} | Get pbx hardware phone
*ConversationApi* | [**getPbxHardwarePhoneManufacturers**](docs/Api/ConversationApi.md#getpbxhardwarephonemanufacturers) | **GET** /conversation/pbx/hardware_phone/manufacturers | Get pbx hardware phone manufacturers
*ConversationApi* | [**getPbxHardwarePhones**](docs/Api/ConversationApi.md#getpbxhardwarephones) | **GET** /conversation/pbx/hardware_phone | Get pbx hardware phones
...
*ConversationApi* | [**getPbxPayConnectors**](docs/Api/ConversationApi.md#getpbxpayconnectors) | **GET** /conversation/pbx/pay_connector | Get pbx pay connectors
...
*ConversationApi* | [**getUserPbxAudios**](docs/Api/ConversationApi.md#getuserpbxaudios) | **GET** /conversation/pbx/audio/user | Get user pbx audios
...
*ConversationApi* | [**insertAgentStatusConfig**](docs/Api/ConversationApi.md#insertagentstatusconfig) | **POST** /conversation/agent/status/config | Create a custom agent status
...
*ConversationApi* | [**insertPbxClassOfService**](docs/Api/ConversationApi.md#insertpbxclassofservice) | **POST** /conversation/pbx/class_of_service | Insert pbx class of service
*ConversationApi* | [**insertPbxHardwarePhone**](docs/Api/ConversationApi.md#insertpbxhardwarephone) | **POST** /conversation/pbx/hardware_phone | Insert pbx hardware phone
...
*ConversationApi* | [**regeneratePasswordForPbxHardwarePhone**](docs/Api/ConversationApi.md#regeneratepasswordforpbxhardwarephone) | **POST** /conversation/pbx/hardware_phone/{conversationPbxHardwarePhoneUuid}/regenerate_password | Update pbx hardware phone
...
*ConversationApi* | [**searchAgentStatusHistory**](docs/Api/ConversationApi.md#searchagentstatushistory) | **POST** /conversation/agent/status/history/search | Search agent status history
*ConversationApi* | [**searchAgentStatusRollups**](docs/Api/ConversationApi.md#searchagentstatusrollups) | **POST** /conversation/agent/status/rollup/search | Search per-(agent, day) rollups
...
*ConversationApi* | [**updateAgentStatusConfig**](docs/Api/ConversationApi.md#updateagentstatusconfig) | **PUT** /conversation/agent/status/config/{conversation_status_uuid} | Update a custom agent status
...
*ConversationApi* | [**updateUserPbxAudio**](docs/Api/ConversationApi.md#updateuserpbxaudio) | **PUT** /conversation/pbx/audio/user/{conversationPbxAudioUuid} | Update user pbx audio
...
*ConversationEmbedApi* | [**embedOauthDeviceAuthorize**](docs/Api/ConversationEmbedApi.md#embedoauthdeviceauthorize) | **POST** /conversation_embed/oauth/device/authorize | Initiate a device authorization flow for an embed widget.
*ConversationEmbedApi* | [**embedOauthRevoke**](docs/Api/ConversationEmbedApi.md#embedoauthrevoke) | **POST** /conversation_embed/oauth/device/revoke | Revoke an embed widget access or refresh token.
*ConversationEmbedApi* | [**embedOauthToken**](docs/Api/ConversationEmbedApi.md#embedoauthtoken) | **POST** /conversation_embed/oauth/device/token | Exchange a device_code or refresh_token for an access token (embed widget).
*ConversationEmbedApi* | [**getEmbedPbxAuth**](docs/Api/ConversationEmbedApi.md#getembedpbxauth) | **PUT** /conversation_embed/pbx-auth | Get PBX authorization for the embedded softphone widget.
...
*CustomerApi* | [**updateCustomerEmailSuppression**](docs/Api/CustomerApi.md#updatecustomeremailsuppression) | **POST** /customer/customers/{customer_profile_oid}/email_suppression | Clear email suppression for a customer
...
*ItemApi* | [**deleteAllGatedCodes**](docs/Api/ItemApi.md#deleteallgatedcodes) | **DELETE** /item/items/{merchant_item_oid}/gated_codes | Delete all gated access codes for an item
...
*ItemApi* | [**deleteGatedCode**](docs/Api/ItemApi.md#deletegatedcode) | **DELETE** /item/items/{merchant_item_oid}/gated_codes/{merchant_item_gated_code_oid} | Delete a gated access code by OID
...
*ItemApi* | [**generateGatedCodes**](docs/Api/ItemApi.md#generategatedcodes) | **POST** /item/items/{merchant_item_oid}/gated_codes/generate | Generate a batch of gated access codes
...
*ItemApi* | [**getGatedCodes**](docs/Api/ItemApi.md#getgatedcodes) | **GET** /item/items/{merchant_item_oid}/gated_codes | Get gated access codes for an item
...
*ItemApi* | [**insertGatedCode**](docs/Api/ItemApi.md#insertgatedcode) | **POST** /item/items/{merchant_item_oid}/gated_codes | Add a single gated access code to an item
...
*ItemApi* | [**replaceGatedCodes**](docs/Api/ItemApi.md#replacegatedcodes) | **PUT** /item/items/{merchant_item_oid}/gated_codes | Replace the full list of gated access codes for an item
...
*OrderApi* | [**getAccountsReceivableDetailValueHistogram**](docs/Api/OrderApi.md#getaccountsreceivabledetailvaluehistogram) | **GET** /order/accounts_receivable/detail_value_histogram | Retrieve a value histogram for a given AR transaction-detail name
*OrderApi* | [**getAccountsReceivableGatewayDetailNames**](docs/Api/OrderApi.md#getaccountsreceivablegatewaydetailnames) | **GET** /order/accounts_receivable/gateway_detail_names | Retrieve gateway / detail-name picker data for the AR filter modal
...
*SfvbApi* | [**getSfvbExperiment**](docs/Api/SfvbApi.md#getsfvbexperiment) | **GET** /sfvb/storefronts/{storefront_oid}/experiments/{experiment_oid} | Read one experiment and its statistics
...
*SfvbApi* | [**listSfvbElements**](docs/Api/SfvbApi.md#listsfvbelements) | **GET** /sfvb/elements | List every SFVB element type
...
*StorefrontApi* | [**getEmailCustomerDispatchLogs**](docs/Api/StorefrontApi.md#getemailcustomerdispatchlogs) | **GET** /storefront/{storefront_oid}/email/customers/{email_customer_uuid}/dispatch_logs | Get a customer&#39;s dispatch-log journey across all flows/campaigns
...
*StorefrontApi* | [**getEmailDispatchLogCustomerLookup**](docs/Api/StorefrontApi.md#getemaildispatchlogcustomerlookup) | **GET** /storefront/{storefront_oid}/email/dispatch_logs/customer_lookup | Resolve a customer email to its ESP customer UUID
...
*StorefrontApi* | [**getEmailStepDispatchLogDetail**](docs/Api/StorefrontApi.md#getemailstepdispatchlogdetail) | **GET** /storefront/{storefront_oid}/email/commseqs/{commseq_uuid}/steps/{commseq_step_uuid}/dispatch_logs/detail | Get the full detail of a single dispatch-log record
*StorefrontApi* | [**getEmailStepDispatchLogs**](docs/Api/StorefrontApi.md#getemailstepdispatchlogs) | **GET** /storefront/{storefront_oid}/email/commseqs/{commseq_uuid}/steps/{commseq_step_uuid}/dispatch_logs | Get a paginated, date-boundable dispatch-log feed for a step
...
- [AutoOrderPaymentUpdateRequest](docs/Model/AutoOrderPaymentUpdateRequest.md)
...
- [AutoOrderRebillResponse](docs/Model/AutoOrderRebillResponse.md)
...
- [BulkJobRequest](docs/Model/BulkJobRequest.md)
- [BulkJobResponse](docs/Model/BulkJobResponse.md)
- [BulkJobsResponse](docs/Model/BulkJobsResponse.md)
- [BulkRecord](docs/Model/BulkRecord.md)
- [BulkRecordsResponse](docs/Model/BulkRecordsResponse.md)
- [BulkUploadUrlResponse](docs/Model/BulkUploadUrlResponse.md)
...
- [ConversationAgentCallEvent](docs/Model/ConversationAgentCallEvent.md)
- [ConversationAgentChatEvent](docs/Model/ConversationAgentChatEvent.md)
...
- [ConversationAgentStatusConfig](docs/Model/ConversationAgentStatusConfig.md)
- [ConversationAgentStatusConfigResponse](docs/Model/ConversationAgentStatusConfigResponse.md)
- [ConversationAgentStatusConfigsResponse](docs/Model/ConversationAgentStatusConfigsResponse.md)
- [ConversationAgentStatusEvent](docs/Model/ConversationAgentStatusEvent.md)
- [ConversationAgentStatusHeatmapRequest](docs/Model/ConversationAgentStatusHeatmapRequest.md)
- [ConversationAgentStatusHeatmapResponse](docs/Model/ConversationAgentStatusHeatmapResponse.md)
- [ConversationAgentStatusHistorySearchRequest](docs/Model/ConversationAgentStatusHistorySearchRequest.md)
- [ConversationAgentStatusHistorySearchResponse](docs/Model/ConversationAgentStatusHistorySearchResponse.md)
- [ConversationAgentStatusRollup](docs/Model/ConversationAgentStatusRollup.md)
- [ConversationAgentStatusRollupSearchRequest](docs/Model/ConversationAgentStatusRollupSearchRequest.md)
...
- [ConversationEmbedPbxAuthResponse](docs/Model/ConversationEmbedPbxAuthResponse.md)
...
- [ConversationPbxCall](docs/Model/ConversationPbxCall.md)
...
- [ConversationPbxCallFinancial](docs/Model/ConversationPbxCallFinancial.md)
- [ConversationPbxCallHold](docs/Model/ConversationPbxCallHold.md)
- [ConversationPbxCallQueue](docs/Model/ConversationPbxCallQueue.md)
- [ConversationPbxCallRecording](docs/Model/ConversationPbxCallRecording.md)
- [ConversationPbxCallResponse](docs/Model/ConversationPbxCallResponse.md)
- [ConversationPbxCallRouting](docs/Model/ConversationPbxCallRouting.md)
- [ConversationPbxCallSearchRequest](docs/Model/ConversationPbxCallSearchRequest.md)
- [ConversationPbxCallSearchResponse](docs/Model/ConversationPbxCallSearchResponse.md)
- [ConversationPbxCallTimeline](docs/Model/ConversationPbxCallTimeline.md)
...
- [ConversationPbxCosAuditLog](docs/Model/ConversationPbxCosAuditLog.md)
- [ConversationPbxCosAuditLogsResponse](docs/Model/ConversationPbxCosAuditLogsResponse.md)
...
- [ConversationPbxDefaultTimezoneResponse](docs/Model/ConversationPbxDefaultTimezoneResponse.md)
- [ConversationPbxDefaultTimezoneUpdateRequest](docs/Model/ConversationPbxDefaultTimezoneUpdateRequest.md)
- [ConversationPbxHardwarePhone](docs/Model/ConversationPbxHardwarePhone.md)
- [ConversationPbxHardwarePhoneResponse](docs/Model/ConversationPbxHardwarePhoneResponse.md)
- [ConversationPbxHardwarePhonesResponse](docs/Model/ConversationPbxHardwarePhonesResponse.md)
...
- [ConversationPbxPayConnector](docs/Model/ConversationPbxPayConnector.md)
- [ConversationPbxPayConnectorsResponse](docs/Model/ConversationPbxPayConnectorsResponse.md)
- [ConversationPbxPhoneManufacturer](docs/Model/ConversationPbxPhoneManufacturer.md)
- [ConversationPbxPhoneManufacturersResponse](docs/Model/ConversationPbxPhoneManufacturersResponse.md)
- [ConversationPbxPhoneModel](docs/Model/ConversationPbxPhoneModel.md)
...
- [CouponAmountOffItemsAndFreeShipping](docs/Model/CouponAmountOffItemsAndFreeShipping.md)
...
- [CustomerEmailSuppressionRequest](docs/Model/CustomerEmailSuppressionRequest.md)
- [CustomerEmailSuppressionResponse](docs/Model/CustomerEmailSuppressionResponse.md)
- [CustomerEmailSuppressionResult](docs/Model/CustomerEmailSuppressionResult.md)
...
- [EmailCustomerLookupResponse](docs/Model/EmailCustomerLookupResponse.md)
...
- [EmailDispatchLog](docs/Model/EmailDispatchLog.md)
- [EmailDispatchLogDetail](docs/Model/EmailDispatchLogDetail.md)
- [EmailDispatchLogDetailResponse](docs/Model/EmailDispatchLogDetailResponse.md)
- [EmailDispatchLogsResponse](docs/Model/EmailDispatchLogsResponse.md)
...
- [EmailSuppressionSurfaces](docs/Model/EmailSuppressionSurfaces.md)
...
- [FraudRuleResponse](docs/Model/FraudRuleResponse.md)
- [FraudRuleRotatingTransactionGatewayFilter](docs/Model/FraudRuleRotatingTransactionGatewayFilter.md)
- [FraudRuleSearchRequest](docs/Model/FraudRuleSearchRequest.md)
- [FraudRuleStorefrontFilter](docs/Model/FraudRuleStorefrontFilter.md)
- [FraudRulesResponse](docs/Model/FraudRulesResponse.md)
...
- [ItemGatedCode](docs/Model/ItemGatedCode.md)
- [ItemGatedCodeResponse](docs/Model/ItemGatedCodeResponse.md)
- [ItemGatedCodesRequest](docs/Model/ItemGatedCodesRequest.md)
- [ItemGatedCodesResponse](docs/Model/ItemGatedCodesResponse.md)
- [ItemGenerateGatedCodesRequest](docs/Model/ItemGenerateGatedCodesRequest.md)
...
- [SfvbContainerResponse](docs/Model/SfvbContainerResponse.md)
- [SfvbContainerRevertRequest](docs/Model/SfvbContainerRevertRequest.md)
- [SfvbContainerVersion](docs/Model/SfvbContainerVersion.md)
- [SfvbContainerVersionsResponse](docs/Model/SfvbContainerVersionsResponse.md)
- [SfvbContainerWriteRequest](docs/Model/SfvbContainerWriteRequest.md)
- [SfvbElement](docs/Model/SfvbElement.md)
- [SfvbElementSchemaResponse](docs/Model/SfvbElementSchemaResponse.md)
- [SfvbElementsResponse](docs/Model/SfvbElementsResponse.md)
- [SfvbErrorDetail](docs/Model/SfvbErrorDetail.md)
- [SfvbExperiment](docs/Model/SfvbExperiment.md)
- [SfvbExperimentEndRequest](docs/Model/SfvbExperimentEndRequest.md)
- [SfvbExperimentObjective](docs/Model/SfvbExperimentObjective.md)
- [SfvbExperimentObjectivesResponse](docs/Model/SfvbExperimentObjectivesResponse.md)
- [SfvbExperimentStartRequest](docs/Model/SfvbExperimentStartRequest.md)
- [SfvbExperimentStartVariation](docs/Model/SfvbExperimentStartVariation.md)
- [SfvbExperimentVariationUpdateRequest](docs/Model/SfvbExperimentVariationUpdateRequest.md)
- [SfvbExperimentsResponse](docs/Model/SfvbExperimentsResponse.md)
- [SfvbFileContentResponse](docs/Model/SfvbFileContentResponse.md)
- [SfvbFileEntry](docs/Model/SfvbFileEntry.md)
...
- [SfvbPageBlogPostSelector](docs/Model/SfvbPageBlogPostSelector.md)
- [SfvbPageBlogPostsRequest](docs/Model/SfvbPageBlogPostsRequest.md)
- [SfvbPageBlogPostsResponse](docs/Model/SfvbPageBlogPostsResponse.md)
- [SfvbPageCreateRequest](docs/Model/SfvbPageCreateRequest.md)
- [SfvbPageDuplicateRequest](docs/Model/SfvbPageDuplicateRequest.md)
- [SfvbPageItem](docs/Model/SfvbPageItem.md)
- [SfvbPageItemSelector](docs/Model/SfvbPageItemSelector.md)
- [SfvbPageItemsAddRequest](docs/Model/SfvbPageItemsAddRequest.md)
- [SfvbPageItemsRemoveRequest](docs/Model/SfvbPageItemsRemoveRequest.md)
- [SfvbPageItemsResponse](docs/Model/SfvbPageItemsResponse.md)
...
- [SfvbPageSummary](docs/Model/SfvbPageSummary.md)
...
- [SfvbVersionResponse](docs/Model/SfvbVersionResponse.md)
- [SfvbWhoamiResponse](docs/Model/SfvbWhoamiResponse.md)
- [SfvbWidgetIdsResponse](docs/Model/SfvbWidgetIdsResponse.md)
...
- [TimelineSummary](docs/Model/TimelineSummary.md)
