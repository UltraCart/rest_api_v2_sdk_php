...
/**
 * CartProfileRegisterResponse Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ultracart\admin\v2
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CartProfileRegisterResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CartProfileRegisterResponse';
    ...
    /**
     * Sets errors
     * @param string[] $errors Errors to display to the customer if they failed any of the validations checked
     * @return $this
     */
