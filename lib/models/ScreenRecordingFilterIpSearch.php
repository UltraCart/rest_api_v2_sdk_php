 ...
 */
class ScreenRecordingFilterIpSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenRecordingFilterIpSearch';
