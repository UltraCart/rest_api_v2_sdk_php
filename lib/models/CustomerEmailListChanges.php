 ...
 */
class CustomerEmailListChanges implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerEmailListChanges';
    ...
    {
        $this->container['add_to_lists'] = $data['add_to_lists'] ?? null;
        $this->container['remove_from_lists'] = $data['remove_from_lists'] ?? null;
    }
     ...
     * Sets add_to_lists
     *
     * @param string[]|null $add_to_lists Add this customer to these email lists
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $remove_from_lists Remove this customer from these email lists
     *
     * @return self
     */
