 ...
 */
class CouponFreeItemWithItemPurchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponFreeItemWithItemPurchase';
