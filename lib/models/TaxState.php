...
class TaxState implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets vat_threshold
     *
     * @param float|null $vat_threshold VAT collection threshold override for this region. Blank inherits the country threshold, 0 always collects VAT, a positive value collects at or below that order subtotal.
     *
     * @return self
     */
