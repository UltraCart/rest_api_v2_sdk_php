 ...
 */
class ConversationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationsResponse';
    ...
    {
        $this->container['conversations'] = $data['conversations'] ?? null;
     ...
     * Sets conversations
     *
     * @param \ultracart\v2\models\ConversationSummary[]|null $conversations conversations
     *
     * @return self
     */
