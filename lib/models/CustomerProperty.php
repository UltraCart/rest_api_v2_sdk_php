...
/**
 * CustomerProperty Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CustomerProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerProperty';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomerProperty., must be smaller than or equal to 100.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 1500)) {
            throw new \InvalidArgumentException('invalid length for $value when calling CustomerProperty., must be smaller than or equal to 1500.');
        }
