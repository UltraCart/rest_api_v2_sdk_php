...
/**
 * CouponAmountOffShippingWithItemsPurchase Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CouponAmountOffShippingWithItemsPurchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponAmountOffShippingWithItemsPurchase';
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CouponAmountOffShippingWithItemsPurchase., must be smaller than or equal to 3.');
        }
     ...
     * Sets items
     *
     * @param string[]|null $items A list of items of which at least one must be purchased for coupon to be valid.
     *
     * @return self
     */
