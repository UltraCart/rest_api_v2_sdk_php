 ...
 */
class ScreenRecordingFilterRangeBigDecimal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenRecordingFilterRangeBigDecimal';
