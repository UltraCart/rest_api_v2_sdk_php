 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CouponFreeItemsWithMixMatchPurchase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CouponFreeItemsWithMixMatchPurchase';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['required_purchase_mix_and_match_group'] = isset($data['required_purchase_mix_and_match_group']) ? $data['required_purchase_mix_and_match_group'] : null;
     ...
     * Sets limit
     *
     * @param int $limit The limit of free items that may be received when purchasing multiple mix and match group items
     *
     * @return $this
     */
     ...
     *
     * @param string $required_purchase_mix_and_match_group Required mix and match group that must be purchased for coupon to be valid
     *
     * @return $this
     */
