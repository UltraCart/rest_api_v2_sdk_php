...
/**
 * WorkflowTasksResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WorkflowTasksResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WorkflowTasksResponse';
     ...
     * Sets task_context
     *
     * @param string $task_context User friendly string of the task context if querying for a specific object type/id
     *
     * @return $this
     */
     ...
     * Gets tasks
     *
     * @return \ultracart\v2\models\WorkflowTask[]
     */
     ...
     * Sets tasks
     *
     * @param \ultracart\v2\models\WorkflowTask[] $tasks tasks
     *
     * @return $this
     */
