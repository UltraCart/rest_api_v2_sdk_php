...
class CouponResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['items_invalid_for_coupons'] = $data['items_invalid_for_coupons'] ?? null;
     ...
     * Sets coupon
     *
     * @param \ultracart\v2\models\Coupon|null $coupon coupon
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $items_invalid_for_coupons Items invalid for coupons.  These will display as warnings within the UI.
     *
     * @return self
     */
