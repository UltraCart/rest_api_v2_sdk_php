...
/**
 * CustomerStoreCreditLedgerEntry Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CustomerStoreCreditLedgerEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerStoreCreditLedgerEntry';
     ...
     * Sets action
     *
     * @param string|null $action Identifies the state of this ledger entry whether the entry is Vesting or Expiring
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomerStoreCreditLedgerEntry., must be smaller than or equal to 50.');
        }
