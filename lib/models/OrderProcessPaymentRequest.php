 ...
 */
class OrderProcessPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderProcessPaymentRequest';
     ...
     * Sets amount
     *
     * @param float|null $amount Specific amount to bill (optional).  If not specified the total of the order is billed.
     *
     * @return self
     */
     ...
     *
     * @param string|null $card_verification_number_token Card verification number token from hosted fields used during credit card transaction processing (optional)
     *
     * @return self
     */
