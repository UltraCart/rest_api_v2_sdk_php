...
class AutoOrderItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $calculated_next_shipment_dts Calculated Date/time that this item is scheduled to rebill.  Will be null if no more shipments are going to occur on this item
     *
     * @return self
     */
