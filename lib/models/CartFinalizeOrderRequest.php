 ...
 */
class CartFinalizeOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartFinalizeOrderRequest';
     ...
     * Gets options
     *
     * @return \ultracart\v2\models\CartFinalizeOrderRequestOptions|null
     */
     ...
     * Sets options
     *
     * @param \ultracart\v2\models\CartFinalizeOrderRequestOptions|null $options options
     *
     * @return self
     */
