...
/**
 * CouponFreeItemWithItemPurchaseAndFreeShipping Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CouponFreeItemWithItemPurchaseAndFreeShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponFreeItemWithItemPurchaseAndFreeShipping';
     ...
     * Sets items
     *
     * @param string[]|null $items A list of free items which will receive a discount if one of the required purchase items is purchased.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit The (optional) maximum quantity of discounted items.  Free shipping will apply to all units of the free item ids though.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $match_required_purchase_item_to_free_item If true then the free item is matched 1:1 with the free item in the list.
     *
     * @return self
     */
