 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CouponFreeItemWithItemPurchaseAndFreeShipping implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CouponFreeItemWithItemPurchaseAndFreeShipping';
     ...
     * Sets limit
     *
     * @param int $limit The (optional) maximum quantity of discounted items.  Free shipping will apply to all units of the free item ids though.
     *
     * @return $this
     */
