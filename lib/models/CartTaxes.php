 ...
 */
class CartTaxes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartTaxes';
     ...
     * Sets county
     *
     * @param string|null $county Tax county if the state requires it.
     *
     * @return self
     */
     ...
     * Sets exempt
     *
     * @param bool|null $exempt True if tax exempt
     *
     * @return self
     */
