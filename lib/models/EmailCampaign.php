...
class EmailCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCampaign';
     ...
     *
     * @param string|null $click_rate_formatted Click rate of emails
     *
     * @return self
     */
     ...
     *
     * @param bool|null $end_once_customer_purchases True if the customer should end the flow once they purchase from this campaign
     *
     * @return self
     */
     ...
     *
     * @param bool|null $end_once_customer_purchases_anywhere True if the customer should end the flow once they purchase from anywhere
     *
     * @return self
     */
     ...
     *
     * @param string|null $esp_campaign_folder_uuid Campaign folder UUID.  Null for uncategorized
     *
     * @return self
     */
     ...
     *
     * @param string|null $esp_domain_user User of the sending address
     *
     * @return self
     */
     ...
     *
     * @param string|null $esp_domain_uuid UUID of the sending domain
     *
     * @return self
     */
     ...
     * Gets memberships
     *
     * @return \ultracart\v2\models\EmailListSegmentMembership[]|null
     */
     ...
     * Sets memberships
     *
     * @param \ultracart\v2\models\EmailListSegmentMembership[]|null $memberships List and segment memberships
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of email campaign
     *
     * @return self
     */
     ...
     *
     * @param string|null $open_rate_formatted Open rate of emails
     *
     * @return self
     */
     ...
     *
     * @param bool|null $prevent_sending_due_to_spam True if this campaign is prevented from sending at this time due to spam complaints.
     *
     * @return self
     */
     ...
     *
     * @param string|null $revenue_formatted Revenue associated with campaign
     *
     * @return self
     */
     ...
     *
     * @param string|null $revenue_per_customer_formatted Revenue per customer associated with campaign
     *
     * @return self
     */
     ...
     * Sets scheduled_dts
     *
     * @param string|null $scheduled_dts Scheduled date
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Status of the campaign of draft, archived, and sent
     *
     * @return self
     */
