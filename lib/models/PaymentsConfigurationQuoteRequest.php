...
/**
 * PaymentsConfigurationQuoteRequest Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentsConfigurationQuoteRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentsConfigurationQuoteRequest';
    ...
    /**
     * Gets accept_quote_requests
     *
     * @return bool
     */
    public function getAcceptQuoteRequests()
    {
        return $this->container['accept_quote_requests'];
    }
     ...
     * @return $this
     */
    public function setAcceptQuoteRequests($accept_quote_requests)
    {
        $this->container['accept_quote_requests'] = $accept_quote_requests;
