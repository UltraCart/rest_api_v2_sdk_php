...
class Order implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['current_stage_histories'] = $data['current_stage_histories'] ?? null;
     ...
     *
     * @return \ultracart\v2\models\OrderCurrentStageHistory[]|null
     */
     ...
     *
     * @param \ultracart\v2\models\OrderCurrentStageHistory[]|null $current_stage_histories History of the changes to the current_stage field
     *
     * @return self
     */
     ...
     * Sets reject_reason
     *
     * @param string|null $reject_reason Reject reason code.  This can only be written during a reject operation otherwise this field is read only.
     *
     * @return self
     */
     ...
     * Gets utms
     *
     * @return \ultracart\v2\models\OrderUtm[]|null
     */
     ...
     * Sets utms
     *
     * @param \ultracart\v2\models\OrderUtm[]|null $utms UTM clicks.  The zero index is the most recent (last) UTM click
     *
     * @return self
     */
