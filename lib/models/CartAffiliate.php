 ...
 */
class CartAffiliate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartAffiliate';
     ...
     * Sets affiliate_id
     *
     * @param int|null $affiliate_id Affiliate id associated with the cart
     *
     * @return self
     */
     ...
     *
     * @param string|null $affiliate_sub_id Affiliate sub id associated with the cart
     *
     * @return self
     */
