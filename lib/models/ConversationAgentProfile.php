...
class ConversationAgentProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const AI_VOICE_PERSONALITY_ARA = 'Ara';
    public const AI_VOICE_PERSONALITY_REX = 'Rex';
    public const AI_VOICE_PERSONALITY_SAL = 'Sal';
    public const AI_VOICE_PERSONALITY_EVE = 'Eve';
    public const AI_VOICE_PERSONALITY_LEO = 'Leo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ai_voice_instructions'] = $data['ai_voice_instructions'] ?? null;
        $this->container['ai_voice_personality'] = $data['ai_voice_personality'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ai_voice_personality']) && !in_array($this->container['ai_voice_personality'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'ai_voice_personality', must be one of '%s'",
                $this->container['ai_voice_personality'],
     ...
     *
     * @param string|null $ai_voice_instructions Additional voice instructions for this AI when handling voice calls
     *
     * @return self
     */
     ...
     *
     * @param string|null $ai_voice_personality Which AI voice personality to use when handling the call.
     *
     * @return self
     */
