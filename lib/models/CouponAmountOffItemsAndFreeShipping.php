...
/**
 * CouponAmountOffItemsAndFreeShipping Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CouponAmountOffItemsAndFreeShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponAmountOffItemsAndFreeShipping';
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CouponAmountOffItemsAndFreeShipping., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param float|null $discount_amount The amount of discount
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param string[]|null $items A list of items which are eligible for the discount amount.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit The limit of items which are eligible for the discount amount.
     *
     * @return self
     */
