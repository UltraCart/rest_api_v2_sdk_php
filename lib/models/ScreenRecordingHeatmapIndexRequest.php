 ...
 */
class ScreenRecordingHeatmapIndexRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenRecordingHeatmapIndexRequest';
    ...
    {
        $this->container['url_contains'] = $data['url_contains'] ?? null;
    }
