...
/**
 * EmailDispatchLog Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class EmailDispatchLog implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailDispatchLog';
     ...
     * Sets email
     *
     * @param string|null $email Customer email, resolved from the customer UUID for the page
     *
     * @return self
     */
