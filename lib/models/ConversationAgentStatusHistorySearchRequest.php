...
/**
 * ConversationAgentStatusHistorySearchRequest Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationAgentStatusHistorySearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationAgentStatusHistorySearchRequest';
     ...
     * Sets date_end
     *
     * @param string|null $date_end Date range end (ISO 8601 or YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets date_start
     *
     * @param string|null $date_start Date range start (ISO 8601 or YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Optional new_status filter
     *
     * @return self
     */
     ...
     * Sets trigger
     *
     * @param string|null $trigger Optional trigger filter
     *
     * @return self
     */
