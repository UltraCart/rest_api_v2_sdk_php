 ...
 */
class ItemInstantPaymentNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemInstantPaymentNotification';
    ...
    {
        $this->container['post_operation'] = $data['post_operation'] ?? null;
        $this->container['successful_response_text'] = $data['successful_response_text'] ?? null;
     ...
     * Sets post_operation
     *
     * @param bool|null $post_operation True for HTTP POST instead of GET
     *
     * @return self
     */
     ...
     *
     * @param string|null $successful_response_text Successful response text
     *
     * @return self
     */
