 ...
 */
class ItemChargebackAddendum implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemChargebackAddendum';
    ...
    {
        $this->container['chargeback_addendum_oid'] = $data['chargeback_addendum_oid'] ?? null;
     ...
     *
     * @param int|null $chargeback_addendum_oid Chargeback addendum object identifier
     *
     * @return self
     */
     ...
     * Sets file_size
     *
     * @param int|null $file_size Size of the file
     *
     * @return self
     */
