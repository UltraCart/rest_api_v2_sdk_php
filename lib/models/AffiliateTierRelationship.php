...
/**
 * AffiliateTierRelationship Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class AffiliateTierRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AffiliateTierRelationship';
     ...
     * Sets affiliate_oid
     *
     * @param int|null $affiliate_oid Affiliate object ID that recruited the affiliate
     *
     * @return self
     */
     ...
     * Sets tier_number
     *
     * @param int|null $tier_number Tier number
     *
     * @return self
     */
