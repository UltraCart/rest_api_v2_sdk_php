 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationPbxCosAuditLogsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConversationPbxCosAuditLogsResponse';
    ...
    {
        $this->container['audit_logs'] = isset($data['audit_logs']) ? $data['audit_logs'] : null;
     ...
     * Gets audit_logs
     *
     * @return \ultracart\v2\models\ConversationPbxCosAuditLog[]
     */
     ...
     * Sets audit_logs
     *
     * @param \ultracart\v2\models\ConversationPbxCosAuditLog[] $audit_logs Array of audit log entries
     *
     * @return $this
     */
