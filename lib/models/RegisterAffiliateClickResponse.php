 ...
 */
class RegisterAffiliateClickResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterAffiliateClickResponse';
    ...
    {
        $this->container['cookie_max_age'] = $data['cookie_max_age'] ?? null;
        $this->container['cookie_names'] = $data['cookie_names'] ?? null;
        $this->container['cookie_values'] = $data['cookie_values'] ?? null;
        $this->container['registered'] = $data['registered'] ?? null;
    }
     ...
     * Sets cookie_max_age
     *
     * @param int|null $cookie_max_age The cookie max age to use
     *
     * @return self
     */
     ...
     * Sets cookie_names
     *
     * @param string[]|null $cookie_names The names of all the cookies to set on the browser
     *
     * @return self
     */
     ...
     * Sets cookie_values
     *
     * @param string[]|null $cookie_values The values of all the cookies to set on the browser
     *
     * @return self
     */
     ...
     * Sets registered
     *
     * @param bool|null $registered True if a click was registered
     *
     * @return self
     */
