 ...
 */
class EmailFlowFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailFlowFolder';
     ...
     *
     * @param string|null $esp_flow_folder_uuid Email flow folder UUID
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of email flow folder
     *
     * @return self
     */
