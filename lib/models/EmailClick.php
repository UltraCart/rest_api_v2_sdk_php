 ...
 */
class EmailClick implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailClick';
     ...
     * Sets click_count
     *
     * @param int|null $click_count Click Count
     *
     * @return self
     */
