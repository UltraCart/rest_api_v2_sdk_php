 ...
 */
class LibraryItemPublishedMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LibraryItemPublishedMeta';
    ...
    {
        $this->container['count_of_versions'] = $data['count_of_versions'] ?? null;
        $this->container['library_item_published_oid'] = $data['library_item_published_oid'] ?? null;
        $this->container['library_item_review_oid'] = $data['library_item_review_oid'] ?? null;
        ...
        $this->container['review_version'] = $data['review_version'] ?? null;
     ...
     *
     * @param int|null $count_of_versions The number of published versions a source item has, or zero if this item is not a source or is private
     *
     * @return self
     */
     ...
     *
     * @param int|null $library_item_published_oid The oid pointing to the most recent published version, or zero if this is not a published source item.
     *
     * @return self
     */
     ...
     *
     * @param int|null $library_item_review_oid The oid pointing to the review data if this is a source library item and currently under review
     *
     * @return self
     */
     ...
     * Sets rejected
     *
     * @param bool|null $rejected True if this is a source item and is under review and was rejected.
     *
     * @return self
     */
     ...
     *
     * @param string|null $rejected_reason The reason for rejection if this item is a source item, is under review, and was rejected.  For all other cases, this value will be null or missing.
     *
     * @return self
     */
     ...
     *
     * @param int|null $release_version If this library item is a source item and it is published, this is the most recent release version number
     *
     * @return self
     */
     ...
     * Sets review_version
     *
     * @param int|null $review_version If this library item is a source item and has a published item currently under review, this is that version number
     *
     * @return self
     */
     ...
     * Sets under_review
     *
     * @param bool|null $under_review True if this library item is a source item and is currently under review
     *
     * @return self
     */
