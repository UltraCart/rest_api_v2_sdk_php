 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReportPageVisualizationMetric implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReportPageVisualizationMetric';
     ...
     * Sets aggregation
     *
     * @param string $aggregation Aggregation to perform
     *
     * @return $this
     */
     ...
     * Sets round
     *
     * @param int $round Number of places after the decimal point to round the number to.
     *
     * @return $this
     */
