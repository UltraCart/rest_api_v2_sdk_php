...
/**
 * EmailCustomerLookupResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class EmailCustomerLookupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCustomerLookupResponse';
     ...
     * Sets email
     *
     * @param string|null $email The email that was looked up
     *
     * @return self
     */
     ...
     *
     * @param string|null $esp_customer_uuid ESP customer UUID, or null when the email is not on file
     *
     * @return self
     */
