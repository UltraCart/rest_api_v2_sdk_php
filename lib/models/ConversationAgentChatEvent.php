...
/**
 * ConversationAgentChatEvent Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationAgentChatEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationAgentChatEvent';
     ...
     * Sets customer_name
     *
     * @param string|null $customer_name Customer display name (when known)
     *
     * @return self
     */
     ...
     * Sets end_dts
     *
     * @param string|null $end_dts Chat ended
     *
     * @return self
     */
     ...
     * Sets message_count
     *
     * @param int|null $message_count Total messages in the conversation
     *
     * @return self
     */
     ...
     * Sets start_dts
     *
     * @param string|null $start_dts Chat started
     *
     * @return self
     */
