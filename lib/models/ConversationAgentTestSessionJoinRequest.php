...
/**
 * ConversationAgentTestSessionJoinRequest Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationAgentTestSessionJoinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationAgentTestSessionJoinRequest';
     ...
     *
     * @param string|null $conversation_webchat_queue_uuid Queue entry uuid returned when the test session was started
     *
     * @return self
     */
