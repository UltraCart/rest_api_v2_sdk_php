...
/**
 * BulkUploadUrlResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class BulkUploadUrlResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkUploadUrlResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['max_records'] = $data['max_records'] ?? null;
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at When the presigned URL expires
     *
     * @return self
     */
     ...
     * Sets max_records
     *
     * @param int|null $max_records Per-job record cap
     *
     * @return self
     */
     ...
     * Sets s3_key
     *
     * @param string|null $s3_key Opaque reference to pass back on POST /rest/v2/bulk/{object}
     *
     * @return self
     */
     ...
     * Sets upload_url
     *
     * @param string|null $upload_url Presigned S3 PUT URL (short-lived)
     *
     * @return self
     */
