...
/**
 * EmailCustomerEditorUrlResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class EmailCustomerEditorUrlResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCustomerEditorUrlResponse';
    ...
    {
        $this->container['editor_url'] = $data['editor_url'] ?? null;
     ...
     * Sets editor_url
     *
     * @param string|null $editor_url editor_url
     *
     * @return self
     */
