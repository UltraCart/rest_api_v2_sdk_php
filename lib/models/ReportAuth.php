 ...
 */
class ReportAuth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportAuth';
     ...
     * Sets client_uuid
     *
     * @param string|null $client_uuid Unique UUID assigned to this client
     *
     * @return self
     */
