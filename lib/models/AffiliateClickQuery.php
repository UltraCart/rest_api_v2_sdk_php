 ...
 */
class AffiliateClickQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AffiliateClickQuery';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['click_dts_begin'] = $data['click_dts_begin'] ?? null;
        $this->container['click_dts_end'] = $data['click_dts_end'] ?? null;
     ...
     * Sets affiliate_oid
     *
     * @param int|null $affiliate_oid Affiliate ID associated with the click
     *
     * @return self
     */
     ...
     *
     * @param string|null $click_dts_begin Minimum click date/time to return
     *
     * @return self
     */
     ...
     * Sets click_dts_end
     *
     * @param string|null $click_dts_end Maximum click date/time to return
     *
     * @return self
     */
