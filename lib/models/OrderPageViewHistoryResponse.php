...
/**
 * OrderPageViewHistoryResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class OrderPageViewHistoryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderPageViewHistoryResponse';
    ...
    protected static $openAPITypes = [
        ...
        'page_views' => '\ultracart\v2\models\OrderPageView[]',
        'referrer' => 'string',
        'success' => 'bool',
     ...
     * Gets page_views
     *
     * @return \ultracart\v2\models\OrderPageView[]|null
     */
     ...
     * Sets page_views
     *
     * @param \ultracart\v2\models\OrderPageView[]|null $page_views Page views captured during the session that placed this order
     *
     * @return self
     */
     ...
     * Sets referrer
     *
     * @param string|null $referrer HTTP referrer captured at the start of the session that placed this order
     *
     * @return self
     */
