...
class EmailSettings implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['require_order_within_last'] = isset($data['require_order_within_last']) ? $data['require_order_within_last'] : null;
     ...
     *
     * @param int $require_order_within_last Require order within last
     *
     * @return $this
     */
