...
/**
 * TransactionEmailListResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class TransactionEmailListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransactionEmailListResponse';
    ...
    {
        $this->container['email_names'] = $data['email_names'] ?? null;
    ...
    {
        return $this->container['email_names'];
    }

    /**
     * Sets email_names
     *
     * @param string[]|null $email_names email_names
     *
     * @return self
     */
