 ...
 */
class ScreenRecordingFilterStringSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenRecordingFilterStringSearch';
    ...
    {
        $this->container['does_not_exist'] = $data['does_not_exist'] ?? null;
        $this->container['exists'] = $data['exists'] ?? null;
        $this->container['is'] = $data['is'] ?? null;
        $this->container['is_not'] = $data['is_not'] ?? null;
        $this->container['starts_with'] = $data['starts_with'] ?? null;
    }
     ...
     * Sets does_not_exist
     *
     * @param bool|null $does_not_exist does_not_exist
     *
     * @return self
     */
     ...
     * Sets starts_with
     *
     * @param string|null $starts_with starts_with
     *
     * @return self
     */
