...
/**
 * CouponAmountShippingWithSubtotal Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CouponAmountShippingWithSubtotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponAmountShippingWithSubtotal';
    ...
    public function setCurrencyCode($currency_code)
    {
        if (!is_null($currency_code) && (mb_strlen($currency_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency_code when calling CouponAmountShippingWithSubtotal., must be smaller than or equal to 3.');
        }
     ...
     *
     * @param float|null $shipping_amount The amount of the shipping cost (this is not a discount, this is the actual cost of shipping)
     *
     * @return self
     */
