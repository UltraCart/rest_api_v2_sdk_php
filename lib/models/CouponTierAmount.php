 ...
 */
class CouponTierAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponTierAmount';
     ...
     *
     * @param float|null $subtotal_amount The amount of subtotal required to receive the discount amount
     *
     * @return self
     */
