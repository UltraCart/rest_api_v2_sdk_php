...
/**
 * ConversationAgentStatusHeatmapRequest Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationAgentStatusHeatmapRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationAgentStatusHeatmapRequest';
    ...
    public const METRIC_AVAILABILITY = 'availability';
    public const METRIC_CALL_VOLUME = 'call_volume';
    public const METRIC_CHAT_VOLUME = 'chat_volume';
    ...
    public function getMetricAllowableValues()
    {
        return [
            ...
            self::METRIC_CALL_VOLUME,
            self::METRIC_CHAT_VOLUME,
        ];
    }
     ...
     * Sets date_end
     *
     * @param string|null $date_end Range end (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets date_start
     *
     * @param string|null $date_start Range start (YYYY-MM-DD)
     *
     * @return self
     */
     ...
     * Sets metric
     *
     * @param string|null $metric Cell metric
     *
     * @return self
     */
