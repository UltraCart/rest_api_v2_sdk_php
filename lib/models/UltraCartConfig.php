 ...
 */
class UltraCartConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UltraCartConfig';
     ...
     * Sets tax_billing
     *
     * @param bool|null $tax_billing True if sales tax should be collected based on billing address instead of shipping address
     *
     * @return self
     */
