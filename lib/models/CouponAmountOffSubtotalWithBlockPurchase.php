 ...
 */
class CouponAmountOffSubtotalWithBlockPurchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponAmountOffSubtotalWithBlockPurchase';
     ...
     *
     * @param int|null $required_purchase_quantity Discount amount is multiplied by the number of blocks.  A block is this many quantity of the required item.
     *
     * @return self
     */
