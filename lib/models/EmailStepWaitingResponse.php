 ...
 */
class EmailStepWaitingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailStepWaitingResponse';
    ...
    {
        $this->container['step_waitings'] = $data['step_waitings'] ?? null;
    }
     ...
     * Gets step_waitings
     *
     * @return \ultracart\v2\models\StepWaiting[]|null
     */
     ...
     * Sets step_waitings
     *
     * @param \ultracart\v2\models\StepWaiting[]|null $step_waitings step_waitings
     *
     * @return self
     */
