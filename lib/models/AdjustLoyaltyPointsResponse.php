...
/**
 * AdjustLoyaltyPointsResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class AdjustLoyaltyPointsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdjustLoyaltyPointsResponse';
     ...
     * Sets current_points
     *
     * @param int|null $current_points The current (vested) points balance after the adjustment was made
     *
     * @return self
     */
     ...
     * Sets loyalty_points
     *
     * @param int|null $loyalty_points The loyalty points adjustment that was written to the ledger
     *
     * @return self
     */
     ...
     * Sets pending_points
     *
     * @param int|null $pending_points The pending (unvested) points balance after the adjustment was made
     *
     * @return self
     */
