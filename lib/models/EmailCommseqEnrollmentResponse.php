...
/**
 * EmailCommseqEnrollmentResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class EmailCommseqEnrollmentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCommseqEnrollmentResponse';
    ...
    protected static $setters = [
        'already_enrolled' => 'setAlreadyEnrolled',
    ...
    protected static $getters = [
        'already_enrolled' => 'getAlreadyEnrolled',
    ...
    {
        $this->container['already_enrolled'] = $data['already_enrolled'] ?? null;
        $this->container['enrolled'] = $data['enrolled'] ?? null;
    ...
    /**
     * Gets already_enrolled
     *
     * @return bool|null
     */
    public function getAlreadyEnrolled()
    {
        return $this->container['already_enrolled'];
    }

    /**
     * Sets already_enrolled
     *
     * @param bool|null $already_enrolled True if the customer was already enrolled and therefore not enrolled again
     *
     * @return self
     */
    public function setAlreadyEnrolled($already_enrolled)
    {
        $this->container['already_enrolled'] = $already_enrolled;
     ...
     * Sets enrolled
     *
     * @param bool|null $enrolled True if the customer was newly enrolled into the sequence
     *
     * @return self
     */
     ...
     *
     * @param string|null $esp_customer_uuid The resolved ESP customer UUID for the enrolled email
     *
     * @return self
     */
