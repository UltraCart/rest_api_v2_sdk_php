 ...
 */
class CouponPercentOffItemWithItemsQuantityPurchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponPercentOffItemWithItemsQuantityPurchase';
     ...
     * Sets item_tags
     *
     * @param string[]|null $item_tags An optional list of item tags which will receive a discount if one of the required purchased items is purchased.
     *
     * @return self
     */
     ...
     * Sets items
     *
     * @param string[]|null $items A list of items which will receive a discount if one of the required purchase items is purchased.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $required_purchase_items Required items (at least one from the list) that must be purchased for coupon to be valid
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $required_purchase_items_tags Required item tags (at least one from the list) that must be purchase for coupon to be valid.
     *
     * @return self
     */
