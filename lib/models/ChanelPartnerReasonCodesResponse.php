 ...
 */
class ChanelPartnerReasonCodesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChanelPartnerReasonCodesResponse';
