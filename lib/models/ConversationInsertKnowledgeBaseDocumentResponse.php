...
/**
 * ConversationInsertKnowledgeBaseDocumentResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationInsertKnowledgeBaseDocumentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationInsertKnowledgeBaseDocumentResponse';
    ...
    {
        $this->container['document_uuid'] = $data['document_uuid'] ?? null;
        $this->container['error'] = $data['error'] ?? null;
        $this->container['metadata'] = $data['metadata'] ?? null;
        $this->container['s3_key'] = $data['s3_key'] ?? null;
        $this->container['success'] = $data['success'] ?? null;
        $this->container['vector_keys'] = $data['vector_keys'] ?? null;
     ...
     * Sets document_uuid
     *
     * @param string|null $document_uuid document_uuid
     *
     * @return self
     */
     ...
     * @return string[]|null
     */
    public function getVectorKeys()
    {
        return $this->container['vector_keys'];
    }

    /**
     * Sets vector_keys
     *
     * @param string[]|null $vector_keys vector_keys
     *
     * @return self
     */
    public function setVectorKeys($vector_keys)
    {
        $this->container['vector_keys'] = $vector_keys;
