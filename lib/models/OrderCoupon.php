...
class OrderCoupon implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['base_coupon_code']) && (strlen($this->container['base_coupon_code']) > 20)) {
            $invalid_properties[] = "invalid value for 'base_coupon_code', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['coupon_code']) && (strlen($this->container['coupon_code']) > 20)) {
            $invalid_properties[] = "invalid value for 'coupon_code', the character length must be smaller than or equal to 20.";
        }
