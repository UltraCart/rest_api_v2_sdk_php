 ...
 */
class EmailFlowBackPopulateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailFlowBackPopulateRequest';
    ...
    {
        $this->container['order_days_old'] = $data['order_days_old'] ?? null;
        $this->container['relative_to_event'] = $data['relative_to_event'] ?? null;
    }
     ...
     * Sets order_days_old
     *
     * @param int|null $order_days_old The age of the orders that should be considered for order triggers.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $relative_to_event True if the age of the event should be considered when reducing the initial flow wait step
     *
     * @return self
     */
