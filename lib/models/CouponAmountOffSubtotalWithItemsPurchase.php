 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CouponAmountOffSubtotalWithItemsPurchase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CouponAmountOffSubtotalWithItemsPurchase';
     ...
     * Sets items
     *
     * @param string[] $items A list of items of which a quantity of one or many must be purchased for coupon to be valid.
     *
     * @return $this
     */
