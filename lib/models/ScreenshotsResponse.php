...
/**
 * ScreenshotsResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ScreenshotsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenshotsResponse';
     ...
     * Sets screenshots
     *
     * @param string[]|null $screenshots List of screenshot urls related to the object (depends on which method was called).
     *
     * @return self
     */
