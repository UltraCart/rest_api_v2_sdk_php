 ...
 */
class ReportDataSetPageResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportDataSetPageResponse';
     ...
     * Sets page
     *
     * @param \ultracart\v2\models\ReportDataSetPage|null $page page
     *
     * @return self
     */
