...
/**
 * CouponTierQuantityAmount Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CouponTierQuantityAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponTierQuantityAmount';
     ...
     *
     * @param float|null $discount_amount The amount of discount per item.
     *
     * @return self
     */
    ...
    public function setQuickbooksCode($quickbooks_code)
    {
        if (!is_null($quickbooks_code) && (mb_strlen($quickbooks_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $quickbooks_code when calling CouponTierQuantityAmount., must be smaller than or equal to 20.');
        }
