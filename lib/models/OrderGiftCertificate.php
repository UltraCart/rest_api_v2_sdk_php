...
/**
 * OrderGiftCertificate Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class OrderGiftCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderGiftCertificate';
     ...
     *
     * @param string|null $gift_certificate_code Gift certificate code used on the order
     *
     * @return self
     */
     ...
     *
     * @param int|null $gift_certificate_oid Gift certificate object identifier
     *
     * @return self
     */
