...
/**
 * ConversationAgentStatusHeatmapResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class ConversationAgentStatusHeatmapResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationAgentStatusHeatmapResponse';
     ...
     * Sets agents
     *
     * @param string[]|null $agents Y-axis labels (one per agent)
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param object[]|null $data Sparse cells. Each row is [agent_index, hour, value]; empty cells are omitted.
     *
     * @return self
     */
     ...
     * Sets hours
     *
     * @param int[]|null $hours X-axis values (hours of day, 0-23)
     *
     * @return self
     */
