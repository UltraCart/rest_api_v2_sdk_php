 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TempMultimedia implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['multimedia_type'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getMultimediaTypeAllowableValues();
        if (!is_null($multimedia_type) && !in_array($multimedia_type, $allowedValues)) {
