 ...
 */
class OrderByTokenQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderByTokenQuery';
     ...
     * Sets order_token
     *
     * @param string|null $order_token Order Token
     *
     * @return self
     */
