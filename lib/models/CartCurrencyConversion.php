 ...
 */
class CartCurrencyConversion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CartCurrencyConversion';
     ...
     *
     * @param string|null $base_currency_code Base currency code for this merchant
     *
     * @return self
     */
     ...
     * Sets currencies
     *
     * @param \ultracart\v2\models\Currency[]|null $currencies Conversion information for 1 unit of base currency to target currencies
     *
     * @return self
     */
