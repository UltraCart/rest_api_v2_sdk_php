...
/**
 * CustomerMergeRequest Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class CustomerMergeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerMergeRequest';
     ...
     *
     * @param int|null $customer_profile_oid Customer profile oid to merge
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Email of the customer profile to merge
     *
     * @return self
     */
