 ...
 */
class ConversationKnowledgeBaseDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConversationKnowledgeBaseDocument';
    ...
    {
        $this->container['chunk_count'] = $data['chunk_count'] ?? null;
     ...
     * Sets document_id
     *
     * @param string|null $document_id Human readable identifier.  Filename is recommended.
     *
     * @return self
     */
