...
/**
 * BulkJobsResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class BulkJobsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BulkJobsResponse';
    ...
    protected static $openAPITypes = [
        'bulk_jobs' => '\ultracart\v2\models\BulkJob[]',
    ...
    {
        $this->container['bulk_jobs'] = $data['bulk_jobs'] ?? null;
     ...
     * Gets bulk_jobs
     *
     * @return \ultracart\v2\models\BulkJob[]|null
     */
    public function getBulkJobs()
    {
        return $this->container['bulk_jobs'];
    }

    /**
     * Sets bulk_jobs
     *
     * @param \ultracart\v2\models\BulkJob[]|null $bulk_jobs Bulk jobs
     *
     * @return self
     */
    public function setBulkJobs($bulk_jobs)
    {
        $this->container['bulk_jobs'] = $bulk_jobs;
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Opaque cursor for the next page, null when exhausted
     *
     * @return self
     */
