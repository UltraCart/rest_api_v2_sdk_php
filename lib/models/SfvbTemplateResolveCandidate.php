...
/**
 * SfvbTemplateResolveCandidate Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class SfvbTemplateResolveCandidate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SfvbTemplateResolveCandidate';
     ...
     * Sets skipped
     *
     * @param string|null $skipped Why the storefront never uses this file for a page, or null.  snippets means it sits in the resource path's own snippets folder.
     *
     * @return self
     */
