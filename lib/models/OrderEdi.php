 ...
 */
class OrderEdi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderEdi';
    ...
    {
        $this->container['bill_to_edi_code'] = $data['bill_to_edi_code'] ?? null;
        $this->container['edi_department'] = $data['edi_department'] ?? null;
        $this->container['edi_internal_vendor_number'] = $data['edi_internal_vendor_number'] ?? null;
     ...
     *
     * @param string|null $bill_to_edi_code Billing address identification code from the EDI order.  Typically DUNS or DUNS+4
     *
     * @return self
     */
     ...
     * Sets edi_department
     *
     * @param string|null $edi_department Department number associated with this EDI order
     *
     * @return self
     */
     ...
     *
     * @param string|null $edi_internal_vendor_number Internal vendor number associated with this EDI order
     *
     * @return self
     */
     ...
     *
     * @param string|null $ship_to_edi_code Shipping address identification code from the EDI order.  Typically DUNS or DUNS+4
     *
     * @return self
     */
