 ...
 */
class OrderReplacementItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReplacementItem';
     ...
     *
     * @param float|null $arbitrary_unit_cost Cost to charge the customer if specified.  If not specified then the default item cost is used.
     *
     * @return self
     */
