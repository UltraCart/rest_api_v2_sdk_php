...
class OrderDigitalOrder implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'items' => '\ultracart\admin\v2\models\OrderDigitalItem[]',
        'url' => 'string',
        'url_id' => 'string'
    );
    ...
    /**
     * Gets items
     * @return \ultracart\admin\v2\models\OrderDigitalItem[]
     */
    ...
    /**
     * Sets items
     * @param \ultracart\admin\v2\models\OrderDigitalItem[] $items Digital items associated with the digital order
     * @return $this
     */
