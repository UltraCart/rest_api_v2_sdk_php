 ...
 */
class PointOfSaleRegister implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PointOfSaleRegister';
     ...
     * Sets merchant_id
     *
     * @param string|null $merchant_id The merchant id that owns this point of sale register.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of the register.
     *
     * @return self
     */
     ...
     *
     * @param int|null $pos_location_oid Object identifier of the point of sale location where this register is located.
     *
     * @return self
     */
     ...
     *
     * @param int|null $pos_register_oid Object identifier of the point of sale register.
     *
     * @return self
     */
