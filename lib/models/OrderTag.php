 ...
 */
class OrderTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTag';
    ...
    public function setTagValue($tag_value)
    {
        if (!is_null($tag_value) && (mb_strlen($tag_value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tag_value when calling OrderTag., must be smaller than or equal to 100.');
        }
