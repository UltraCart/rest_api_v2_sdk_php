...
/**
 * StoreFrontPageContentAttribute Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class StoreFrontPageContentAttribute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreFrontPageContentAttribute';
    ...
    {
        if (!is_null($name) && (mb_strlen($name) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StoreFrontPageContentAttribute., must be smaller than or equal to 100000.');
        }
     ...
     *
     * @param int|null $translated_text_instance_oid Attribute translated text instance identifier
     *
     * @return self
     */
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling StoreFrontPageContentAttribute., must be smaller than or equal to 100000.');
        }
