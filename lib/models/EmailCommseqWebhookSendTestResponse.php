...
/**
 * EmailCommseqWebhookSendTestResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class EmailCommseqWebhookSendTestResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCommseqWebhookSendTestResponse';
     ...
     * Sets request
     *
     * @param string|null $request HTTP Request
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string|null $response HTTP Response
     *
     * @return self
     */
