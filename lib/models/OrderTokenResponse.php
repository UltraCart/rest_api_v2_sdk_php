 ...
 */
class OrderTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderTokenResponse';
     ...
     * Sets order_token
     *
     * @param string|null $order_token An order token that securely represents an order id
     *
     * @return self
     */
