...
/**
 * OrderTokenResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracartv2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderTokenResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderTokenResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['order_token'] = isset($data['order_token']) ? $data['order_token'] : null;
     ...
     * Sets order_token
     *
     * @param string $order_token An order token that securely represents an order id
     *
     * @return $this
     */
