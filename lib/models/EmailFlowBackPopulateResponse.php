 ...
 */
class EmailFlowBackPopulateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailFlowBackPopulateResponse';
