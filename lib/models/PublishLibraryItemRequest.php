 ...
 */
class PublishLibraryItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublishLibraryItemRequest';
     ...
     * Sets release_notes
     *
     * @param string|null $release_notes Release notes for this release version.
     *
     * @return self
     */
