 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SingleSignOnAuthorizeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SingleSignOnAuthorizeResponse';
     ...
     * Sets expiration_dts
     *
     * @param string $expiration_dts Expiration date/time after which the single sign-on login operation will have timed out
     *
     * @return $this
     */
     ...
     * Sets login_url
     *
     * @param string $login_url The URL that you should redirect the customer's browser to.  This URL will begin the login process.
     *
     * @return $this
     */
