...
/**
 * SingleSignOnAuthorizeResponse Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class SingleSignOnAuthorizeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleSignOnAuthorizeResponse';
     ...
     * Sets expiration_dts
     *
     * @param string|null $expiration_dts Expiration date/time after which the single sign-on login operation will have timed out
     *
     * @return self
     */
     ...
     * Sets login_url
     *
     * @param string|null $login_url The URL that you should redirect the customer's browser to.  This URL will begin the login process.
     *
     * @return self
     */
