...
class WebhookEventSubscription implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['event_ruler'] = isset($data['event_ruler']) ? $data['event_ruler'] : null;
     ...
     * Sets event_ruler
     *
     * @param string $event_ruler Optional - Event ruler expression to filter events to.  Only events that match this Ruler expression will be transmitted to the webhook.
     *
     * @return $this
     */
