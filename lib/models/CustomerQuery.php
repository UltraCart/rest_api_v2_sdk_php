...
class CustomerQuery implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['any_tags'] = isset($data['any_tags']) ? $data['any_tags'] : null;
     ...
     * Sets all_tags
     *
     * @param string[] $all_tags All tags the customer must have
     *
     * @return $this
     */
     ...
     * Sets any_tags
     *
     * @param string[] $any_tags Any of these tags the customer must have
     *
     * @return $this
     */
