...
class CustomerQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets emails
     *
     * @param string[]|null $emails Emails allows for searching on multiple email addresses and work with our without the single email variable.  You may specify a single email address here or use the email property.
     *
     * @return self
     */
