 ...
 */
class CheckoutHandoffResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutHandoffResponse';
     ...
     * Sets errors
     *
     * @param string[]|null $errors Errors that occurred which are preventing the handoff operation.  Display these to the customer.
     *
     * @return self
     */
     ...
     *
     * @param string|null $redirect_to_url The URL that you should redirect the customers browser to
     *
     * @return self
     */
