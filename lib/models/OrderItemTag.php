...
/**
 * OrderItemTag Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   OpenAPI Generator team
 ...
 */
class OrderItemTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderItemTag';
     ...
     * Sets tag_value
     *
     * @param string|null $tag_value Tag Value
     *
     * @return self
     */
    public function setTagValue($tag_value)
    {
        if (!is_null($tag_value) && (mb_strlen($tag_value) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tag_value when calling OrderItemTag., must be smaller than or equal to 100.');
        }
