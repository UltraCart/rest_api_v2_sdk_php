...
class ApiClient
{
     ...
     */
    public function __construct(\ultracart\admin\v2\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \ultracart\admin\v2\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\ultracart\admin\v2\ObjectSerializer::sanitizeForSerialization($postData));
        }
