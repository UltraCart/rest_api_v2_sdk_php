...
class ApiClient
{
     ...
     */
    public function __construct(\ultracart\v2\Configuration $config = null)
    {
        if ($config == null) {
     ...
     *
     * @throws \ultracart\v2\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers)) {
            ...
            $postData = json_encode(\ultracart\v2\ObjectSerializer::sanitizeForSerialization($postData));
        }
