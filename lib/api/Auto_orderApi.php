...
/**
 * Auto_orderApi Class Doc Comment
 *
 * @category Class
 * @package  ultracart\v2
 * @author   Swagger Codegen team
...
class Auto_orderApi
{
    ...
    public function getAutoOrderWithHttpInfo($auto_order_oid, $_expand = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\AutoOrderResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getAutoOrderAsyncWithHttpInfo($auto_order_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
    ...
    protected function getAutoOrderRequest($auto_order_oid, $_expand = null)
    {
        ...
        // path params
        if ($auto_order_oid !== null) {
            $resourcePath = str_replace('{' . 'auto_order_oid' . '}', ObjectSerializer::toPathValue($auto_order_oid), $resourcePath);
        }
    ...
    public function getAutoOrdersWithHttpInfo($auto_order_code = null, $original_order_id = null, $first_name = null, $last_name = null, $company = null, $city = null, $state = null, $postal_code = null, $country_code = null, $phone = null, $email = null, $original_order_date_begin = null, $original_order_date_end = null, $next_shipment_date_begin = null, $next_shipment_date_end = null, $card_type = null, $item_id = null, $status = null, $_limit = '100', $_offset = '0', $_since = null, $_sort = null, $_expand = null)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\AutoOrdersResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\ultracart\v2\models\ErrorResponse', $e->getResponseHeaders());
    ...
    {
        return $this->updateAutoOrderAsyncWithHttpInfo($auto_order, $auto_order_oid, $_expand)->then(function ($response) {
            return $response[0];
        });
    }
