...
class ItemApi
{
     ...
     */
    public function restItemInventorySnapshotResponse()
    {
        list($response) = $this->restItemInventorySnapshotResponseWithHttpInfo();
        return $response;
    }
     ...
     */
    public function restItemInventorySnapshotResponseWithHttpInfo()
    {
        return $this->restItemInventorySnapshotResponseWithHttpInfoRetry(true );
    }
     ...
     * @return array of \ultracart\v2\models\ItemInventorySnapshotResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function restItemInventorySnapshotResponseWithHttpInfoRetry($retry )
    {
        $returnType = '\ultracart\v2\models\ItemInventorySnapshotResponse';
        $request = $this->restItemInventorySnapshotResponseRequest();
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->restItemInventorySnapshotResponseWithHttpInfoRetry(false );
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restItemInventorySnapshotResponseAsync()
    {
        return $this->restItemInventorySnapshotResponseAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restItemInventorySnapshotResponseAsyncWithHttpInfo()
    {
        $returnType = '\ultracart\v2\models\ItemInventorySnapshotResponse';
        $request = $this->restItemInventorySnapshotResponseRequest();
    ...
    /**
     * Create request for operation 'restItemInventorySnapshotResponse'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function restItemInventorySnapshotResponseRequest()
    {
