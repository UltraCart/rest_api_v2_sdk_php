...
class DatawarehouseApi
{
     ...
     */
    protected function deleteCustomDashboardRequest($custom_dashboard_oid)
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomReportExecutionResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomReportExecutionResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomReportsExecutionResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomReportsExecutionResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function executeCustomReportsRequest($execution_request)
    {
        // verify the required parameter 'execution_request' is set
        if ($execution_request === null || (is_array($execution_request) && count($execution_request) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomDashboardRequest($custom_dashboard_oid)
    {
        // verify the required parameter 'custom_dashboard_oid' is set
        if ($custom_dashboard_oid === null || (is_array($custom_dashboard_oid) && count($custom_dashboard_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomDashboardsResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomDashboardsResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCustomDashboardsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function insertCustomDashboardRequest($dashboard)
    {
     ...
     * @return \ultracart\v2\models\CustomDashboardResponse
     */
    public function updateCustomDashboard($dashboard, $custom_dashboard_oid)
    {
        list($response) = $this->updateCustomDashboardWithHttpInfo($dashboard, $custom_dashboard_oid);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\CustomDashboardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCustomDashboardWithHttpInfo($dashboard, $custom_dashboard_oid)
    {
        return $this->updateCustomDashboardWithHttpInfoRetry(true ,   $dashboard,   $custom_dashboard_oid);
    }
     ...
     * @return array of \ultracart\v2\models\CustomDashboardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCustomDashboardWithHttpInfoRetry($retry ,  $dashboard,  $custom_dashboard_oid)
    {
        $returnType = '\ultracart\v2\models\CustomDashboardResponse';
        $request = $this->updateCustomDashboardRequest($dashboard, $custom_dashboard_oid);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->updateCustomDashboardWithHttpInfoRetry(false ,   $dashboard,   $custom_dashboard_oid);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomDashboardAsync($dashboard, $custom_dashboard_oid)
    {
        return $this->updateCustomDashboardAsyncWithHttpInfo($dashboard, $custom_dashboard_oid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomDashboardAsyncWithHttpInfo($dashboard, $custom_dashboard_oid)
    {
        $returnType = '\ultracart\v2\models\CustomDashboardResponse';
        $request = $this->updateCustomDashboardRequest($dashboard, $custom_dashboard_oid);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCustomDashboardRequest($dashboard, $custom_dashboard_oid)
    {
        // verify the required parameter 'dashboard' is set
        if ($dashboard === null || (is_array($dashboard) && count($dashboard) === 0)) {
            throw new \InvalidArgumentException(
