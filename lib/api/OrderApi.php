...
class OrderApi
{
     ...
     * @return \ultracart\v2\models\OrderResponse
     */
    public function getOrderUpsellCart($upsell_cart_request, $order_id, $_expand = null)
    {
        list($response) = $this->getOrderUpsellCartWithHttpInfo($upsell_cart_request, $order_id, $_expand);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUpsellCartWithHttpInfo($upsell_cart_request, $order_id, $_expand = null)
    {
        return $this->getOrderUpsellCartWithHttpInfoRetry(true ,   $upsell_cart_request,   $order_id,   $_expand);
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderUpsellCartWithHttpInfoRetry($retry ,  $upsell_cart_request,  $order_id,  $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getOrderUpsellCartRequest($upsell_cart_request, $order_id, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getOrderUpsellCartWithHttpInfoRetry(false ,   $upsell_cart_request,   $order_id,   $_expand);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderUpsellCartAsync($upsell_cart_request, $order_id, $_expand = null)
    {
        return $this->getOrderUpsellCartAsyncWithHttpInfo($upsell_cart_request, $order_id, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderUpsellCartAsyncWithHttpInfo($upsell_cart_request, $order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getOrderUpsellCartRequest($upsell_cart_request, $order_id, $_expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrderUpsellCartRequest($upsell_cart_request, $order_id, $_expand = null)
    {
     ...
     * @return \ultracart\v2\models\OrderResponse
     */
    public function heldOrderAddItemsAndRelease($add_items_and_release_request, $order_id, $_expand = null)
    {
        list($response) = $this->heldOrderAddItemsAndReleaseWithHttpInfo($add_items_and_release_request, $order_id, $_expand);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function heldOrderAddItemsAndReleaseWithHttpInfo($add_items_and_release_request, $order_id, $_expand = null)
    {
        return $this->heldOrderAddItemsAndReleaseWithHttpInfoRetry(true ,   $add_items_and_release_request,   $order_id,   $_expand);
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function heldOrderAddItemsAndReleaseWithHttpInfoRetry($retry ,  $add_items_and_release_request,  $order_id,  $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->heldOrderAddItemsAndReleaseRequest($add_items_and_release_request, $order_id, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->heldOrderAddItemsAndReleaseWithHttpInfoRetry(false ,   $add_items_and_release_request,   $order_id,   $_expand);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function heldOrderAddItemsAndReleaseAsync($add_items_and_release_request, $order_id, $_expand = null)
    {
        return $this->heldOrderAddItemsAndReleaseAsyncWithHttpInfo($add_items_and_release_request, $order_id, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function heldOrderAddItemsAndReleaseAsyncWithHttpInfo($add_items_and_release_request, $order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->heldOrderAddItemsAndReleaseRequest($add_items_and_release_request, $order_id, $_expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function heldOrderAddItemsAndReleaseRequest($add_items_and_release_request, $order_id, $_expand = null)
    {
        ...
        if (isset($add_items_and_release_request)) {
            $_tempBody = $add_items_and_release_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function heldOrderReleaseRequest($order_id, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
