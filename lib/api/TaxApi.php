...
class TaxApi
{
     ...
     */
    public function deleteTaxProviderSelfCityRequest($city, $tax_city)
    {
        ...
        if (isset($tax_city)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_city));
            } else {
                $httpBody = $tax_city;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTaxProviderSelfCountryRequest($country_code, $tax_country)
    {
        ...
        if (isset($tax_country)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_country));
            } else {
                $httpBody = $tax_country;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTaxProviderSelfCountyRequest($county, $tax_county)
    {
        ...
        if (isset($tax_county)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_county));
            } else {
                $httpBody = $tax_county;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTaxProviderSelfPostalCodeRequest($postal_code, $tax_postal_code)
    {
        ...
        if (isset($tax_postal_code)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_postal_code));
            } else {
                $httpBody = $tax_postal_code;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTaxProviderSelfStateRequest($state_code, $tax_state)
    {
        ...
        if (isset($tax_state)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_state));
            } else {
                $httpBody = $tax_state;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getTaxProviderAnrok()
    {
        list($response) = $this->getTaxProviderAnrokWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTaxProviderAnrokWithHttpInfo
     *
     * Retrieve the Anrok tax provider
     *
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaxProviderAnrokWithHttpInfo()
    {
        return $this->getTaxProviderAnrokWithHttpInfoRetry(true );
    }



    /**
     * Operation getTaxProviderAnrokWithHttpInfoRetry
     *
     * Retrieve the Anrok tax provider
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaxProviderAnrokWithHttpInfoRetry($retry )
    {
        $returnType = '\ultracart\v2\models\TaxProviderAnrok';
        $request = $this->getTaxProviderAnrokRequest();
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getTaxProviderAnrokWithHttpInfoRetry(false );
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderAnrok' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderAnrok' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderAnrok', []),
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\TaxProviderAnrok',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getTaxProviderAnrokAsync
     *
     * Retrieve the Anrok tax provider
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaxProviderAnrokAsync()
    {
        return $this->getTaxProviderAnrokAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTaxProviderAnrokAsyncWithHttpInfo
     *
     * Retrieve the Anrok tax provider
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaxProviderAnrokAsyncWithHttpInfo()
    {
        $returnType = '\ultracart\v2\models\TaxProviderAnrok';
        $request = $this->getTaxProviderAnrokRequest();
    ...
    /**
     * Create request for operation 'getTaxProviderAnrok'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderAnrokRequest()
    {

        $resourcePath = '/tax/providers/anrok';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getTaxProviderAnrokTest
     *
    ...
    {
        list($response) = $this->getTaxProviderAnrokTestWithHttpInfo();
        return $response;
    }

    /**
     * Operation getTaxProviderAnrokTestWithHttpInfo
     *
     * Attempts to connect to Anrok and returns back the response
     *
     *
    ...
    {
        return $this->getTaxProviderAnrokTestWithHttpInfoRetry(true );
    }



    /**
     * Operation getTaxProviderAnrokTestWithHttpInfoRetry
     *
     * Attempts to connect to Anrok and returns back the response
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getTaxProviderAnrokTestWithHttpInfoRetry(false );
                    }
                }
    ...
    /**
     * Operation getTaxProviderAnrokTestAsync
     *
     * Attempts to connect to Anrok and returns back the response
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaxProviderAnrokTestAsync()
    {
        return $this->getTaxProviderAnrokTestAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTaxProviderAnrokTestAsyncWithHttpInfo
     *
     * Attempts to connect to Anrok and returns back the response
     *
     *
    ...
    /**
     * Create request for operation 'getTaxProviderAnrokTest'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderAnrokTestRequest()
    {

        $resourcePath = '/tax/providers/anrok/test';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderAvalara|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderAvalara|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderAvalaraWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderAvalara' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderAvalara' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderAvalara', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderAvalaraRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderAvalaraCompaniesResult|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderAvalaraCompaniesResult|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderAvalaraCompaniesWithHttpInfoRetry($retry , $tax_provider_avalara)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderAvalaraCompaniesResult' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderAvalaraCompaniesResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderAvalaraCompaniesResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderAvalaraCompaniesRequest($tax_provider_avalara)
    {
        ...
        if (isset($tax_provider_avalara)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_provider_avalara));
            } else {
                $httpBody = $tax_provider_avalara;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderAvalaraTestRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderSelf|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderSelf|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderSelfWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderSelf' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderSelf' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderSelf', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderSelfRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderSelfCountriesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderSelfCountriesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderSelfCountriesWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderSelfCountriesResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderSelfCountriesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderSelfCountriesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderSelfCountriesRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderSelfRegionsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderSelfRegionsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderSelfRegionsByCountryCodeWithHttpInfoRetry($retry , $country_code)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderSelfRegionsResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderSelfRegionsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderSelfRegionsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderSelfRegionsByCountryCodeRequest($country_code)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderSovos|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderSovos|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderSovosWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderSovos' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderSovos' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderSovos', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderSovosRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderSovosTestRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderTaxJar|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderTaxJar|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderTaxJarWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderTaxJar' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderTaxJar' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderTaxJar', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderTaxJarRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderTaxJarTestRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderUltraCart|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderUltraCart|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProviderUltraCartWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderUltraCart' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderUltraCart' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderUltraCart', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProviderUltraCartRequest()
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProvidersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProvidersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTaxProvidersWithHttpInfoRetry($retry , $_limit = 100, $_offset = 0, $_expand = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProvidersResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProvidersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProvidersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaxProvidersRequest($_limit = 100, $_offset = 0, $_expand = null)
    {
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderActivateResult|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxProviderActivateResult|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function setActiveTaxProviderWithHttpInfoRetry($retry , $provider_name)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxProviderActivateResult' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxProviderActivateResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxProviderActivateResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setActiveTaxProviderRequest($provider_name)
    {
    ...
    /**
     * Operation updateTaxProviderAnrok
     *
     * Update the Anrok tax provider
     *
     * @param  \ultracart\v2\models\TaxProviderAnrok $tax_provider_anrok TaxProviderAnrok object (required)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function updateTaxProviderAnrok($tax_provider_anrok)
    {
        list($response) = $this->updateTaxProviderAnrokWithHttpInfo($tax_provider_anrok);
        return $response;
    }

    /**
     * Operation updateTaxProviderAnrokWithHttpInfo
     *
     * Update the Anrok tax provider
     *
     * @param  \ultracart\v2\models\TaxProviderAnrok $tax_provider_anrok TaxProviderAnrok object (required)
     ...
     * @return array of \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTaxProviderAnrokWithHttpInfo($tax_provider_anrok)
    {
        return $this->updateTaxProviderAnrokWithHttpInfoRetry(true ,   $tax_provider_anrok);
    }



    /**
     * Operation updateTaxProviderAnrokWithHttpInfoRetry
     *
     * Update the Anrok tax provider
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\TaxProviderAnrok|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateTaxProviderAnrokWithHttpInfoRetry($retry , $tax_provider_anrok)
    {
        $returnType = '\ultracart\v2\models\TaxProviderAnrok';
        $request = $this->updateTaxProviderAnrokRequest($tax_provider_anrok);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->updateTaxProviderAnrokWithHttpInfoRetry(false ,   $tax_provider_anrok);
                    }
                }
    ...
    /**
     * Operation updateTaxProviderAnrokAsync
     *
     * Update the Anrok tax provider
     *
     * @param  \ultracart\v2\models\TaxProviderAnrok $tax_provider_anrok TaxProviderAnrok object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxProviderAnrokAsync($tax_provider_anrok)
    {
        return $this->updateTaxProviderAnrokAsyncWithHttpInfo($tax_provider_anrok)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateTaxProviderAnrokAsyncWithHttpInfo
     *
     * Update the Anrok tax provider
     *
     * @param  \ultracart\v2\models\TaxProviderAnrok $tax_provider_anrok TaxProviderAnrok object (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTaxProviderAnrokAsyncWithHttpInfo($tax_provider_anrok)
    {
        $returnType = '\ultracart\v2\models\TaxProviderAnrok';
        $request = $this->updateTaxProviderAnrokRequest($tax_provider_anrok);
    ...
    /**
     * Create request for operation 'updateTaxProviderAnrok'
     *
     * @param  \ultracart\v2\models\TaxProviderAnrok $tax_provider_anrok TaxProviderAnrok object (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderAnrokRequest($tax_provider_anrok)
    {
        // verify the required parameter 'tax_provider_anrok' is set
        if ($tax_provider_anrok === null || (is_array($tax_provider_anrok) && count($tax_provider_anrok) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tax_provider_anrok when calling updateTaxProviderAnrok'
            );
        }
        ...
        // for model (json/xml)
        if (isset($tax_provider_anrok)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_provider_anrok));
            } else {
                $httpBody = $tax_provider_anrok;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderAvalaraRequest($tax_provider_avalara)
    {
        // verify the required parameter 'tax_provider_avalara' is set
        if ($tax_provider_avalara === null || (is_array($tax_provider_avalara) && count($tax_provider_avalara) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfRequest($tax_provider_self)
    {
        ...
        if (isset($tax_provider_self)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_provider_self));
            } else {
                $httpBody = $tax_provider_self;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxCity|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxCity|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateTaxProviderSelfCityWithHttpInfoRetry($retry , $city, $tax_city)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxCity' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxCity' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxCity', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfCityRequest($city, $tax_city)
    {
        // verify the required parameter 'city' is set
        if ($city === null || (is_array($city) && count($city) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxCountry|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxCountry|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateTaxProviderSelfCountryWithHttpInfoRetry($retry , $country_code, $tax_country)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxCountry' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxCountry' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxCountry', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfCountryRequest($country_code, $tax_country)
    {
        // verify the required parameter 'country_code' is set
        if ($country_code === null || (is_array($country_code) && count($country_code) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxCounty|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxCounty|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateTaxProviderSelfCountyWithHttpInfoRetry($retry , $county, $tax_county)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxCounty' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxCounty' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxCounty', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfCountyRequest($county, $tax_county)
    {
        // verify the required parameter 'county' is set
        if ($county === null || (is_array($county) && count($county) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxPostalCode|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxPostalCode|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateTaxProviderSelfPostalCodeWithHttpInfoRetry($retry , $postal_code, $tax_postal_code)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxPostalCode' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxPostalCode' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxPostalCode', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfPostalCodeRequest($postal_code, $tax_postal_code)
    {
        // verify the required parameter 'postal_code' is set
        if ($postal_code === null || (is_array($postal_code) && count($postal_code) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\TaxState|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\TaxState|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateTaxProviderSelfStateWithHttpInfoRetry($retry , $state_code, $tax_state)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\TaxState' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\TaxState' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\TaxState', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSelfStateRequest($state_code, $tax_state)
    {
        // verify the required parameter 'state_code' is set
        if ($state_code === null || (is_array($state_code) && count($state_code) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderSovosRequest($tax_provider_sovos)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderTaxJarRequest($tax_provider_tax_jar)
    {
        ...
        if (isset($tax_provider_tax_jar)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_provider_tax_jar));
            } else {
                $httpBody = $tax_provider_tax_jar;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateTaxProviderUltraCartRequest($tax_provider_ultracart)
    {
        ...
        if (isset($tax_provider_ultracart)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($tax_provider_ultracart));
            } else {
                $httpBody = $tax_provider_ultracart;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
