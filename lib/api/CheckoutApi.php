...
class CheckoutApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAffirmCheckoutRequest($cart_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllowedCountriesRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getStateProvincesForCountryRequest($country_code)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registerAffiliateClickRequest($register_affiliate_click_request, $_expand = null)
    {
        ...
        if (isset($register_affiliate_click_request)) {
            $_tempBody = $register_affiliate_click_request;
        }
