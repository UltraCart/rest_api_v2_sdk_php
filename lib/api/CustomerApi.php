...
class CustomerApi
{
     ...
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     * @param  \ultracart\v2\models\AdjustLoyaltyPointsRequest $adjust_loyalty_points_request adjustLoyaltyPointsRequest (required)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\AdjustLoyaltyPointsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function adjustLoyaltyPoints($customer_profile_oid, $adjust_loyalty_points_request)
    {
        list($response) = $this->adjustLoyaltyPointsWithHttpInfo($customer_profile_oid, $adjust_loyalty_points_request);
        return $response;
    }

    /**
     * Operation adjustLoyaltyPointsWithHttpInfo
     *
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\AdjustLoyaltyPointsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function adjustLoyaltyPointsWithHttpInfo($customer_profile_oid, $adjust_loyalty_points_request)
    {
        return $this->adjustLoyaltyPointsWithHttpInfoRetry(true ,   $customer_profile_oid,   $adjust_loyalty_points_request);
    }



    /**
     * Operation adjustLoyaltyPointsWithHttpInfoRetry
     *
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\AdjustLoyaltyPointsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function adjustLoyaltyPointsWithHttpInfoRetry($retry , $customer_profile_oid, $adjust_loyalty_points_request)
    {
        $returnType = '\ultracart\v2\models\AdjustLoyaltyPointsResponse';
        $request = $this->adjustLoyaltyPointsRequest($customer_profile_oid, $adjust_loyalty_points_request);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->adjustLoyaltyPointsWithHttpInfoRetry(false ,   $customer_profile_oid,   $adjust_loyalty_points_request);
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\AdjustLoyaltyPointsResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\AdjustLoyaltyPointsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\AdjustLoyaltyPointsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\AdjustLoyaltyPointsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation adjustLoyaltyPointsAsync
     *
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adjustLoyaltyPointsAsync($customer_profile_oid, $adjust_loyalty_points_request)
    {
        return $this->adjustLoyaltyPointsAsyncWithHttpInfo($customer_profile_oid, $adjust_loyalty_points_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation adjustLoyaltyPointsAsyncWithHttpInfo
     *
     * Adjusts the loyalty points for a customer by adding a record to the loyalty ledger.
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function adjustLoyaltyPointsAsyncWithHttpInfo($customer_profile_oid, $adjust_loyalty_points_request)
    {
        $returnType = '\ultracart\v2\models\AdjustLoyaltyPointsResponse';
        $request = $this->adjustLoyaltyPointsRequest($customer_profile_oid, $adjust_loyalty_points_request);
    ...
    /**
     * Create request for operation 'adjustLoyaltyPoints'
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     * @param  \ultracart\v2\models\AdjustLoyaltyPointsRequest $adjust_loyalty_points_request adjustLoyaltyPointsRequest (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function adjustLoyaltyPointsRequest($customer_profile_oid, $adjust_loyalty_points_request)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_profile_oid when calling adjustLoyaltyPoints'
            );
        }
        // verify the required parameter 'adjust_loyalty_points_request' is set
        if ($adjust_loyalty_points_request === null || (is_array($adjust_loyalty_points_request) && count($adjust_loyalty_points_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $adjust_loyalty_points_request when calling adjustLoyaltyPoints'
            );
        }

        $resourcePath = '/customer/customers/{customer_profile_oid}/adjust_loyalty_points';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($adjust_loyalty_points_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($adjust_loyalty_points_request));
            } else {
                $httpBody = $adjust_loyalty_points_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteWishListItemRequest($customer_profile_oid, $customer_wishlist_item_oid)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomerLoyaltyResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getCustomerLoyalty($customer_profile_oid)
    {
        list($response) = $this->getCustomerLoyaltyWithHttpInfo($customer_profile_oid);
        return $response;
    }

    /**
     * Operation getCustomerLoyaltyWithHttpInfo
     *
     * Retrieve the loyalty points, ledger and redemptions for a customer
     *
     * @param  int $customer_profile_oid The customer oid to retrieve. (required)
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomerLoyaltyResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerLoyaltyWithHttpInfo($customer_profile_oid)
    {
        return $this->getCustomerLoyaltyWithHttpInfoRetry(true ,   $customer_profile_oid);
    }



    /**
     * Operation getCustomerLoyaltyWithHttpInfoRetry
     *
     * Retrieve the loyalty points, ledger and redemptions for a customer
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\CustomerLoyaltyResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomerLoyaltyWithHttpInfoRetry($retry , $customer_profile_oid)
    {
        $returnType = '\ultracart\v2\models\CustomerLoyaltyResponse';
        $request = $this->getCustomerLoyaltyRequest($customer_profile_oid);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getCustomerLoyaltyWithHttpInfoRetry(false ,   $customer_profile_oid);
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\CustomerLoyaltyResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\CustomerLoyaltyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\CustomerLoyaltyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\CustomerLoyaltyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getCustomerLoyaltyAsync
     *
     * Retrieve the loyalty points, ledger and redemptions for a customer
     *
     * @param  int $customer_profile_oid The customer oid to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerLoyaltyAsync($customer_profile_oid)
    {
        return $this->getCustomerLoyaltyAsyncWithHttpInfo($customer_profile_oid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCustomerLoyaltyAsyncWithHttpInfo
     *
     * Retrieve the loyalty points, ledger and redemptions for a customer
     *
     * @param  int $customer_profile_oid The customer oid to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCustomerLoyaltyAsyncWithHttpInfo($customer_profile_oid)
    {
        $returnType = '\ultracart\v2\models\CustomerLoyaltyResponse';
        $request = $this->getCustomerLoyaltyRequest($customer_profile_oid);
    ...
    /**
     * Create request for operation 'getCustomerLoyalty'
     *
     * @param  int $customer_profile_oid The customer oid to retrieve. (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomerLoyaltyRequest($customer_profile_oid)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_profile_oid when calling getCustomerLoyalty'
            );
        }

        $resourcePath = '/customer/customers/{customer_profile_oid}/loyalty';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomerWishListItemsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomerWishListItemsResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCustomerWishListWithHttpInfoRetry($retry , $customer_profile_oid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\CustomerWishListItemsResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\CustomerWishListItemsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\CustomerWishListItemsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomerWishListRequest($customer_profile_oid)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomerWishListItemResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomerWishListItemResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCustomerWishListItemWithHttpInfoRetry($retry , $customer_profile_oid, $customer_wishlist_item_oid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\CustomerWishListItemResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\CustomerWishListItemResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\CustomerWishListItemResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCustomerWishListItemRequest($customer_profile_oid, $customer_wishlist_item_oid)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomerMagicLinkResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomerMagicLinkResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getMagicLinkWithHttpInfoRetry($retry , $customer_profile_oid, $storefront_host_name)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\CustomerMagicLinkResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\CustomerMagicLinkResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\CustomerMagicLinkResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMagicLinkRequest($customer_profile_oid, $storefront_host_name)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation getQuickBooksOnlineCustomers
     *
     * Search the merchant&#39;s QuickBooks Online customers
     *
     * @param  string $q Search query matched against the QuickBooks Online customer display name (optional)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\QuickBooksOnlineCustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getQuickBooksOnlineCustomers($q = null)
    {
        list($response) = $this->getQuickBooksOnlineCustomersWithHttpInfo($q);
        return $response;
    }

    /**
     * Operation getQuickBooksOnlineCustomersWithHttpInfo
     *
     * Search the merchant&#39;s QuickBooks Online customers
     *
     * @param  string $q Search query matched against the QuickBooks Online customer display name (optional)
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\QuickBooksOnlineCustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getQuickBooksOnlineCustomersWithHttpInfo($q = null)
    {
        return $this->getQuickBooksOnlineCustomersWithHttpInfoRetry(true ,   $q);
    }



    /**
     * Operation getQuickBooksOnlineCustomersWithHttpInfoRetry
     *
     * Search the merchant&#39;s QuickBooks Online customers
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\QuickBooksOnlineCustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getQuickBooksOnlineCustomersWithHttpInfoRetry($retry , $q = null)
    {
        $returnType = '\ultracart\v2\models\QuickBooksOnlineCustomersResponse';
        $request = $this->getQuickBooksOnlineCustomersRequest($q);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getQuickBooksOnlineCustomersWithHttpInfoRetry(false ,   $q);
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\QuickBooksOnlineCustomersResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\QuickBooksOnlineCustomersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\QuickBooksOnlineCustomersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\QuickBooksOnlineCustomersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getQuickBooksOnlineCustomersAsync
     *
     * Search the merchant&#39;s QuickBooks Online customers
     *
     * @param  string $q Search query matched against the QuickBooks Online customer display name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getQuickBooksOnlineCustomersAsync($q = null)
    {
        return $this->getQuickBooksOnlineCustomersAsyncWithHttpInfo($q)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getQuickBooksOnlineCustomersAsyncWithHttpInfo
     *
     * Search the merchant&#39;s QuickBooks Online customers
     *
     * @param  string $q Search query matched against the QuickBooks Online customer display name (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getQuickBooksOnlineCustomersAsyncWithHttpInfo($q = null)
    {
        $returnType = '\ultracart\v2\models\QuickBooksOnlineCustomersResponse';
        $request = $this->getQuickBooksOnlineCustomersRequest($q);
    ...
    /**
     * Create request for operation 'getQuickBooksOnlineCustomers'
     *
     * @param  string $q Search query matched against the QuickBooks Online customer display name (optional)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getQuickBooksOnlineCustomersRequest($q = null)
    {

        $resourcePath = '/customer/quickbooks_online/customers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function insertWishListItem($customer_profile_oid, $wishlist_item)
    {
        list($response) = $this->insertWishListItemWithHttpInfo($customer_profile_oid, $wishlist_item);
        return $response;
    }
     ...
     */
    public function insertWishListItemWithHttpInfo($customer_profile_oid, $wishlist_item)
    {
        return $this->insertWishListItemWithHttpInfoRetry(true ,   $customer_profile_oid,   $wishlist_item);
    }
     ...
     * @return array of \ultracart\v2\models\CustomerWishListItem|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function insertWishListItemWithHttpInfoRetry($retry , $customer_profile_oid, $wishlist_item)
    {
        $returnType = '\ultracart\v2\models\CustomerWishListItem';
        $request = $this->insertWishListItemRequest($customer_profile_oid, $wishlist_item);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->insertWishListItemWithHttpInfoRetry(false ,   $customer_profile_oid,   $wishlist_item);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function insertWishListItemAsync($customer_profile_oid, $wishlist_item)
    {
        return $this->insertWishListItemAsyncWithHttpInfo($customer_profile_oid, $wishlist_item)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function insertWishListItemAsyncWithHttpInfo($customer_profile_oid, $wishlist_item)
    {
        $returnType = '\ultracart\v2\models\CustomerWishListItem';
        $request = $this->insertWishListItemRequest($customer_profile_oid, $wishlist_item);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function insertWishListItemRequest($customer_profile_oid, $wishlist_item)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($wishlist_item)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($wishlist_item));
            } else {
                $httpBody = $wishlist_item;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return void
     */
    public function mergeCustomer($customer_profile_oid, $customer, $_expand = null)
    {
        $this->mergeCustomerWithHttpInfo($customer_profile_oid, $customer, $_expand);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function mergeCustomerWithHttpInfo($customer_profile_oid, $customer, $_expand = null)
    {
        $this->mergeCustomerWithHttpInfoRetry(true ,   $customer_profile_oid,   $customer,   $_expand);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function mergeCustomerWithHttpInfoRetry($retry , $customer_profile_oid, $customer, $_expand = null)
    {
        $returnType = '';
        $request = $this->mergeCustomerRequest($customer_profile_oid, $customer, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        $this->mergeCustomerWithHttpInfoRetry(false ,   $customer_profile_oid,   $customer,   $_expand);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mergeCustomerAsync($customer_profile_oid, $customer, $_expand = null)
    {
        return $this->mergeCustomerAsyncWithHttpInfo($customer_profile_oid, $customer, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mergeCustomerAsyncWithHttpInfo($customer_profile_oid, $customer, $_expand = null)
    {
        $returnType = '';
        $request = $this->mergeCustomerRequest($customer_profile_oid, $customer, $_expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function mergeCustomerRequest($customer_profile_oid, $customer, $_expand = null)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $search_string Search (optional)
     * @param  string $signup_dts_start Signup date start (optional)
     * @param  string $signup_dts_end Signup date end (optional)
     * @param  int $_limit The maximum number of records to return on this one API call. (Max 200) (optional, default to 100)
     * @param  int $_offset Pagination of the record set.  Offset is a zero based index. (optional, default to 0)
     ...
     * @return \ultracart\v2\models\CustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function searchCustomers($search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {
        list($response) = $this->searchCustomersWithHttpInfo($search_string, $signup_dts_start, $signup_dts_end, $_limit, $_offset, $_since, $_sort, $_expand);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\CustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCustomersWithHttpInfo($search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {
        return $this->searchCustomersWithHttpInfoRetry(true ,   $search_string,   $signup_dts_start,   $signup_dts_end,   $_limit,   $_offset,   $_since,   $_sort,   $_expand);
    }



    /**
     * Operation searchCustomersWithHttpInfoRetry
     *
     * Search for customers
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\CustomersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCustomersWithHttpInfoRetry($retry , $search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\CustomersResponse';
        $request = $this->searchCustomersRequest($search_string, $signup_dts_start, $signup_dts_end, $_limit, $_offset, $_since, $_sort, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->searchCustomersWithHttpInfoRetry(false ,   $search_string,   $signup_dts_start,   $signup_dts_end,   $_limit,   $_offset,   $_since,   $_sort,   $_expand);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchCustomersAsync($search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {
        return $this->searchCustomersAsyncWithHttpInfo($search_string, $signup_dts_start, $signup_dts_end, $_limit, $_offset, $_since, $_sort, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchCustomersAsyncWithHttpInfo($search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\CustomersResponse';
        $request = $this->searchCustomersRequest($search_string, $signup_dts_start, $signup_dts_end, $_limit, $_offset, $_since, $_sort, $_expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchCustomersRequest($search_string = null, $signup_dts_start = null, $signup_dts_end = null, $_limit = 100, $_offset = 0, $_since = null, $_sort = null, $_expand = null)
    {

        $resourcePath = '/customer/customers/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation updateCustomerEmailSuppression
     *
     * Clear email suppression for a customer
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     * @param  \ultracart\v2\models\CustomerEmailSuppressionRequest $suppression_changes Suppression changes (required)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\CustomerEmailSuppressionResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function updateCustomerEmailSuppression($customer_profile_oid, $suppression_changes)
    {
        list($response) = $this->updateCustomerEmailSuppressionWithHttpInfo($customer_profile_oid, $suppression_changes);
        return $response;
    }

    /**
     * Operation updateCustomerEmailSuppressionWithHttpInfo
     *
     * Clear email suppression for a customer
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\CustomerEmailSuppressionResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCustomerEmailSuppressionWithHttpInfo($customer_profile_oid, $suppression_changes)
    {
        return $this->updateCustomerEmailSuppressionWithHttpInfoRetry(true ,   $customer_profile_oid,   $suppression_changes);
    }



    /**
     * Operation updateCustomerEmailSuppressionWithHttpInfoRetry
     *
     * Clear email suppression for a customer
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\CustomerEmailSuppressionResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateCustomerEmailSuppressionWithHttpInfoRetry($retry , $customer_profile_oid, $suppression_changes)
    {
        $returnType = '\ultracart\v2\models\CustomerEmailSuppressionResponse';
        $request = $this->updateCustomerEmailSuppressionRequest($customer_profile_oid, $suppression_changes);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->updateCustomerEmailSuppressionWithHttpInfoRetry(false ,   $customer_profile_oid,   $suppression_changes);
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\CustomerEmailSuppressionResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\CustomerEmailSuppressionResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\CustomerEmailSuppressionResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\CustomerEmailSuppressionResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation updateCustomerEmailSuppressionAsync
     *
     * Clear email suppression for a customer
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomerEmailSuppressionAsync($customer_profile_oid, $suppression_changes)
    {
        return $this->updateCustomerEmailSuppressionAsyncWithHttpInfo($customer_profile_oid, $suppression_changes)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateCustomerEmailSuppressionAsyncWithHttpInfo
     *
     * Clear email suppression for a customer
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCustomerEmailSuppressionAsyncWithHttpInfo($customer_profile_oid, $suppression_changes)
    {
        $returnType = '\ultracart\v2\models\CustomerEmailSuppressionResponse';
        $request = $this->updateCustomerEmailSuppressionRequest($customer_profile_oid, $suppression_changes);
    ...
    /**
     * Create request for operation 'updateCustomerEmailSuppression'
     *
     * @param  int $customer_profile_oid The customer profile oid (required)
     * @param  \ultracart\v2\models\CustomerEmailSuppressionRequest $suppression_changes Suppression changes (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCustomerEmailSuppressionRequest($customer_profile_oid, $suppression_changes)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_profile_oid when calling updateCustomerEmailSuppression'
            );
        }
        // verify the required parameter 'suppression_changes' is set
        if ($suppression_changes === null || (is_array($suppression_changes) && count($suppression_changes) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $suppression_changes when calling updateCustomerEmailSuppression'
            );
        }

        $resourcePath = '/customer/customers/{customer_profile_oid}/email_suppression';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($suppression_changes)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($suppression_changes));
            } else {
                $httpBody = $suppression_changes;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return \ultracart\v2\models\CustomerWishListItem|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function updateWishListItem($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        list($response) = $this->updateWishListItemWithHttpInfo($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\CustomerWishListItem|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWishListItemWithHttpInfo($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        return $this->updateWishListItemWithHttpInfoRetry(true ,   $customer_profile_oid,   $customer_wishlist_item_oid,   $wishlist_item);
    }
     ...
     * @return array of \ultracart\v2\models\CustomerWishListItem|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWishListItemWithHttpInfoRetry($retry , $customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        $returnType = '\ultracart\v2\models\CustomerWishListItem';
        $request = $this->updateWishListItemRequest($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->updateWishListItemWithHttpInfoRetry(false ,   $customer_profile_oid,   $customer_wishlist_item_oid,   $wishlist_item);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWishListItemAsync($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        return $this->updateWishListItemAsyncWithHttpInfo($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWishListItemAsyncWithHttpInfo($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        $returnType = '\ultracart\v2\models\CustomerWishListItem';
        $request = $this->updateWishListItemRequest($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWishListItemRequest($customer_profile_oid, $customer_wishlist_item_oid, $wishlist_item)
    {
        // verify the required parameter 'customer_profile_oid' is set
        if ($customer_profile_oid === null || (is_array($customer_profile_oid) && count($customer_profile_oid) === 0)) {
            throw new \InvalidArgumentException(
