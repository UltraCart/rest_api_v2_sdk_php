...
class SsoApi
{
     ...
     * @return \ultracart\v2\models\User
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\User, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    protected function getSsoSessionUserRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function ssoAuthorizeRequest($authorization_request)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function ssoSessionRevokeRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function ssoTokenRequest($token_request)
    {
