...
class ChannelPartnerApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelPartnerOrderRequest($order_id, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelPartnerOrderByChannelPartnerOrderIdRequest($order_id, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\ChanelPartnerReasonCodesResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\ChanelPartnerReasonCodesResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getChannelPartnerReasonCodesRequest($channel_partner_oid)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \ultracart\v2\models\OrderResponse
     */
    public function refundChannelPartnerOrder($order, $order_id, $reject_after_refund = 'false', $skip_customer_notification = 'false', $auto_order_cancel = 'false', $manual_refund = 'false', $reverse_affiliate_transactions = 'true', $issue_store_credit = 'false', $auto_order_cancel_reason = null, $_expand = null)
    {
        list($response) = $this->refundChannelPartnerOrderWithHttpInfo($order, $order_id, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
        return $response;
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundChannelPartnerOrderWithHttpInfo($order, $order_id, $reject_after_refund = 'false', $skip_customer_notification = 'false', $auto_order_cancel = 'false', $manual_refund = 'false', $reverse_affiliate_transactions = 'true', $issue_store_credit = 'false', $auto_order_cancel_reason = null, $_expand = null)
    {
        return $this->refundChannelPartnerOrderWithHttpInfoRetry(true ,   $order,   $order_id,   $reject_after_refund,   $skip_customer_notification,   $auto_order_cancel,   $manual_refund,   $reverse_affiliate_transactions,   $issue_store_credit,   $auto_order_cancel_reason,   $_expand);
    }
     ...
     * @return array of \ultracart\v2\models\OrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundChannelPartnerOrderWithHttpInfoRetry($retry ,  $order,  $order_id,  $reject_after_refund = 'false',  $skip_customer_notification = 'false',  $auto_order_cancel = 'false',  $manual_refund = 'false',  $reverse_affiliate_transactions = 'true',  $issue_store_credit = 'false',  $auto_order_cancel_reason = null,  $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->refundChannelPartnerOrderRequest($order, $order_id, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->refundChannelPartnerOrderWithHttpInfoRetry(false ,   $order,   $order_id,   $reject_after_refund,   $skip_customer_notification,   $auto_order_cancel,   $manual_refund,   $reverse_affiliate_transactions,   $issue_store_credit,   $auto_order_cancel_reason,   $_expand);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundChannelPartnerOrderAsync($order, $order_id, $reject_after_refund = 'false', $skip_customer_notification = 'false', $auto_order_cancel = 'false', $manual_refund = 'false', $reverse_affiliate_transactions = 'true', $issue_store_credit = 'false', $auto_order_cancel_reason = null, $_expand = null)
    {
        return $this->refundChannelPartnerOrderAsyncWithHttpInfo($order, $order_id, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundChannelPartnerOrderAsyncWithHttpInfo($order, $order_id, $reject_after_refund = 'false', $skip_customer_notification = 'false', $auto_order_cancel = 'false', $manual_refund = 'false', $reverse_affiliate_transactions = 'true', $issue_store_credit = 'false', $auto_order_cancel_reason = null, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->refundChannelPartnerOrderRequest($order, $order_id, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function refundChannelPartnerOrderRequest($order, $order_id, $reject_after_refund = 'false', $skip_customer_notification = 'false', $auto_order_cancel = 'false', $manual_refund = 'false', $reverse_affiliate_transactions = 'true', $issue_store_credit = 'false', $auto_order_cancel_reason = null, $_expand = null)
    {
