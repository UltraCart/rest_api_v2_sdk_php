...
class ChannelPartnerApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteChannelPartnerShipToPreferenceRequest($channel_partner_oid, $channel_partner_ship_to_preference_oid)
    {
    ...
    /**
     * Operation getChannelPartnerOrder
     *
     * Retrieve a channel partner order
     *
     * @param  string $order_id The order id to retrieve. (required)
     * @param  string $_expand The object expansion to perform on the result.  See OrderApi.getOrder documentation for examples (optional)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getChannelPartnerOrder($order_id, $_expand = null)
    {
        list($response) = $this->getChannelPartnerOrderWithHttpInfo($order_id, $_expand);
        return $response;
    }

    /**
     * Operation getChannelPartnerOrderWithHttpInfo
     *
     * Retrieve a channel partner order
     *
     * @param  string $order_id The order id to retrieve. (required)
     ...
     */
    public function getChannelPartnerOrderWithHttpInfo($order_id, $_expand = null)
    {
        return $this->getChannelPartnerOrderWithHttpInfoRetry(true ,   $order_id,   $_expand);
    }



    /**
     * Operation getChannelPartnerOrderWithHttpInfoRetry
     *
     * Retrieve a channel partner order
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelPartnerOrderWithHttpInfoRetry($retry , $order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getChannelPartnerOrderRequest($order_id, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getChannelPartnerOrderWithHttpInfoRetry(false ,   $order_id,   $_expand);
                    }
                }
    ...
    /**
     * Operation getChannelPartnerOrderAsync
     *
     * Retrieve a channel partner order
     *
     * @param  string $order_id The order id to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerOrderAsync($order_id, $_expand = null)
    {
        return $this->getChannelPartnerOrderAsyncWithHttpInfo($order_id, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelPartnerOrderAsyncWithHttpInfo
     *
     * Retrieve a channel partner order
     *
     * @param  string $order_id The order id to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerOrderAsyncWithHttpInfo($order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getChannelPartnerOrderRequest($order_id, $_expand);
    ...
    /**
     * Create request for operation 'getChannelPartnerOrder'
     *
     * @param  string $order_id The order id to retrieve. (required)
     * @param  string $_expand The object expansion to perform on the result.  See OrderApi.getOrder documentation for examples (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnerOrderRequest($order_id, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getChannelPartnerOrder'
            );
        }

        $resourcePath = '/channel_partner/orders/{order_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getChannelPartnerOrderByChannelPartnerOrderId
     *
     * Retrieve a channel partner order by the channel partner order id
     *
     * @param  string $order_id The channel partner order id to retrieve. (required)
     * @param  string $_expand The object expansion to perform on the result.  See OrderApi.getOrder documentation for examples (optional)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getChannelPartnerOrderByChannelPartnerOrderId($order_id, $_expand = null)
    {
        list($response) = $this->getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfo($order_id, $_expand);
        return $response;
    }

    /**
     * Operation getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfo
     *
     * Retrieve a channel partner order by the channel partner order id
     *
     * @param  string $order_id The channel partner order id to retrieve. (required)
     ...
     * @return array of \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfo($order_id, $_expand = null)
    {
        return $this->getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfoRetry(true ,   $order_id,   $_expand);
    }



    /**
     * Operation getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfoRetry
     *
     * Retrieve a channel partner order by the channel partner order id
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfoRetry($retry , $order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getChannelPartnerOrderByChannelPartnerOrderIdRequest($order_id, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getChannelPartnerOrderByChannelPartnerOrderIdWithHttpInfoRetry(false ,   $order_id,   $_expand);
                    }
                }
    ...
    /**
     * Operation getChannelPartnerOrderByChannelPartnerOrderIdAsync
     *
     * Retrieve a channel partner order by the channel partner order id
     *
     * @param  string $order_id The channel partner order id to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerOrderByChannelPartnerOrderIdAsync($order_id, $_expand = null)
    {
        return $this->getChannelPartnerOrderByChannelPartnerOrderIdAsyncWithHttpInfo($order_id, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelPartnerOrderByChannelPartnerOrderIdAsyncWithHttpInfo
     *
     * Retrieve a channel partner order by the channel partner order id
     *
     * @param  string $order_id The channel partner order id to retrieve. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerOrderByChannelPartnerOrderIdAsyncWithHttpInfo($order_id, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->getChannelPartnerOrderByChannelPartnerOrderIdRequest($order_id, $_expand);
    ...
    /**
     * Create request for operation 'getChannelPartnerOrderByChannelPartnerOrderId'
     *
     * @param  string $order_id The channel partner order id to retrieve. (required)
     * @param  string $_expand The object expansion to perform on the result.  See OrderApi.getOrder documentation for examples (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnerOrderByChannelPartnerOrderIdRequest($order_id, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling getChannelPartnerOrderByChannelPartnerOrderId'
            );
        }

        $resourcePath = '/channel_partner/orders/by_channel_partner_order_id/{order_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getChannelPartnerReasonCodes
     *
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\ChanelPartnerReasonCodesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getChannelPartnerReasonCodes($channel_partner_oid)
    {
        list($response) = $this->getChannelPartnerReasonCodesWithHttpInfo($channel_partner_oid);
        return $response;
    }

    /**
     * Operation getChannelPartnerReasonCodesWithHttpInfo
     *
     * Retrieve reject and refund reason codes.
     *
     * @param  int $channel_partner_oid (required)
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\ChanelPartnerReasonCodesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelPartnerReasonCodesWithHttpInfo($channel_partner_oid)
    {
        return $this->getChannelPartnerReasonCodesWithHttpInfoRetry(true ,   $channel_partner_oid);
    }



    /**
     * Operation getChannelPartnerReasonCodesWithHttpInfoRetry
     *
     * Retrieve reject and refund reason codes.
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\ChanelPartnerReasonCodesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getChannelPartnerReasonCodesWithHttpInfoRetry($retry , $channel_partner_oid)
    {
        $returnType = '\ultracart\v2\models\ChanelPartnerReasonCodesResponse';
        $request = $this->getChannelPartnerReasonCodesRequest($channel_partner_oid);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getChannelPartnerReasonCodesWithHttpInfoRetry(false ,   $channel_partner_oid);
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\ChanelPartnerReasonCodesResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\ChanelPartnerReasonCodesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\ChanelPartnerReasonCodesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\ChanelPartnerReasonCodesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getChannelPartnerReasonCodesAsync
     *
     * Retrieve reject and refund reason codes.
     *
     * @param  int $channel_partner_oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerReasonCodesAsync($channel_partner_oid)
    {
        return $this->getChannelPartnerReasonCodesAsyncWithHttpInfo($channel_partner_oid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getChannelPartnerReasonCodesAsyncWithHttpInfo
     *
     * Retrieve reject and refund reason codes.
     *
     * @param  int $channel_partner_oid (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getChannelPartnerReasonCodesAsyncWithHttpInfo($channel_partner_oid)
    {
        $returnType = '\ultracart\v2\models\ChanelPartnerReasonCodesResponse';
        $request = $this->getChannelPartnerReasonCodesRequest($channel_partner_oid);
    ...
    /**
     * Create request for operation 'getChannelPartnerReasonCodes'
     *
     * @param  int $channel_partner_oid (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnerReasonCodesRequest($channel_partner_oid)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $channel_partner_oid when calling getChannelPartnerReasonCodes'
            );
        }

        $resourcePath = '/channel_partner/channel_partners/{channel_partner_oid}/reason_codes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\ChannelPartnerShipToPreferenceResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\ChannelPartnerShipToPreferenceResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getChannelPartnerShipToPreferenceWithHttpInfoRetry($retry , $channel_partner_oid, $channel_partner_ship_to_preference_oid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\ChannelPartnerShipToPreferenceResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\ChannelPartnerShipToPreferenceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\ChannelPartnerShipToPreferenceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnerShipToPreferenceRequest($channel_partner_oid, $channel_partner_ship_to_preference_oid)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\ChannelPartnerShipToPreferencesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\ChannelPartnerShipToPreferencesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getChannelPartnerShipToPreferencesWithHttpInfoRetry($retry , $channel_partner_oid)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\ChannelPartnerShipToPreferencesResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\ChannelPartnerShipToPreferencesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\ChannelPartnerShipToPreferencesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnerShipToPreferencesRequest($channel_partner_oid)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\ChannelPartnersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\ChannelPartnersResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getChannelPartnersWithHttpInfoRetry($retry )
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\ChannelPartnersResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\ChannelPartnersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\ChannelPartnersResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getChannelPartnersRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function insertChannelPartnerShipToPreferenceRequest($channel_partner_oid, $ship_to_preference)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($ship_to_preference)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($ship_to_preference));
            } else {
                $httpBody = $ship_to_preference;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation refundChannelPartnerOrder
     *
     ...
     * @param  string $_expand The object expansion to perform on the result.  See OrderApi.refundOrder documentation for examples (optional)
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function refundChannelPartnerOrder($order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        list($response) = $this->refundChannelPartnerOrderWithHttpInfo($order_id, $order, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
        return $response;
    }

    /**
     * Operation refundChannelPartnerOrderWithHttpInfo
     *
     * Refund a channel partner order
     *
     * @param  string $order_id The order id to refund. (required)
     ...
     * @return array of \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundChannelPartnerOrderWithHttpInfo($order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        return $this->refundChannelPartnerOrderWithHttpInfoRetry(true ,   $order_id,   $order,   $reject_after_refund,   $skip_customer_notification,   $auto_order_cancel,   $manual_refund,   $reverse_affiliate_transactions,   $issue_store_credit,   $auto_order_cancel_reason,   $_expand);
    }



    /**
     * Operation refundChannelPartnerOrderWithHttpInfoRetry
     *
     * Refund a channel partner order
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\OrderResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function refundChannelPartnerOrderWithHttpInfoRetry($retry , $order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->refundChannelPartnerOrderRequest($order_id, $order, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->refundChannelPartnerOrderWithHttpInfoRetry(false ,   $order_id,   $order,   $reject_after_refund,   $skip_customer_notification,   $auto_order_cancel,   $manual_refund,   $reverse_affiliate_transactions,   $issue_store_credit,   $auto_order_cancel_reason,   $_expand);
                    }
                }
    ...
    /**
     * Operation refundChannelPartnerOrderAsync
     *
     * Refund a channel partner order
     *
     * @param  string $order_id The order id to refund. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundChannelPartnerOrderAsync($order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        return $this->refundChannelPartnerOrderAsyncWithHttpInfo($order_id, $order, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation refundChannelPartnerOrderAsyncWithHttpInfo
     *
     * Refund a channel partner order
     *
     * @param  string $order_id The order id to refund. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refundChannelPartnerOrderAsyncWithHttpInfo($order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        $returnType = '\ultracart\v2\models\OrderResponse';
        $request = $this->refundChannelPartnerOrderRequest($order_id, $order, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $_expand);
    ...
    /**
     * Create request for operation 'refundChannelPartnerOrder'
     *
     * @param  string $order_id The order id to refund. (required)
     * @param  \ultracart\v2\models\Order $order Order to refund (required)
     * @param  bool $reject_after_refund Reject order after refund (optional, default to false)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundChannelPartnerOrderRequest($order_id, $order, $reject_after_refund = false, $skip_customer_notification = false, $auto_order_cancel = false, $manual_refund = false, $reverse_affiliate_transactions = true, $issue_store_credit = false, $auto_order_cancel_reason = null, $_expand = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling refundChannelPartnerOrder'
            );
        }
        // verify the required parameter 'order' is set
        if ($order === null || (is_array($order) && count($order) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order when calling refundChannelPartnerOrder'
            );
        }

        $resourcePath = '/channel_partner/orders/{order_id}/refund';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateChannelPartnerShipToPreferenceRequest($channel_partner_oid, $channel_partner_ship_to_preference_oid, $ship_to_preference)
    {
        // verify the required parameter 'channel_partner_oid' is set
        if ($channel_partner_oid === null || (is_array($channel_partner_oid) && count($channel_partner_oid) === 0)) {
            throw new \InvalidArgumentException(
