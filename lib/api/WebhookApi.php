...
class WebhookApi
{
    ...
    /**
     * Operation getWebhookEventCategories
     *
     ...
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ultracart\v2\models\WebhookEventCategoriesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse
     */
    public function getWebhookEventCategories()
    {
        list($response) = $this->getWebhookEventCategoriesWithHttpInfo();
        return $response;
    }

    /**
     * Operation getWebhookEventCategoriesWithHttpInfo
     *
     * Retrieve webhook event categories
     *
     *
     * @throws \ultracart\v2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ultracart\v2\models\WebhookEventCategoriesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookEventCategoriesWithHttpInfo()
    {
        return $this->getWebhookEventCategoriesWithHttpInfoRetry(true );
    }



    /**
     * Operation getWebhookEventCategoriesWithHttpInfoRetry
     *
     * Retrieve webhook event categories
     *
     * @param boolean $retry should this method retry the call if a rate limit is triggered (required)
     ...
     * @return array of \ultracart\v2\models\WebhookEventCategoriesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookEventCategoriesWithHttpInfoRetry($retry )
    {
        $returnType = '\ultracart\v2\models\WebhookEventCategoriesResponse';
        $request = $this->getWebhookEventCategoriesRequest();
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getWebhookEventCategoriesWithHttpInfoRetry(false );
                    }
                }
            ...
            switch($statusCode) {
                case 200:
                    if ('\ultracart\v2\models\WebhookEventCategoriesResponse' === '\SplFileObject') {
                        $content = $response->getBody()->getContents(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ultracart\v2\models\WebhookEventCategoriesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\ultracart\v2\models\WebhookEventCategoriesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ultracart\v2\models\WebhookEventCategoriesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getWebhookEventCategoriesAsync
     *
     * Retrieve webhook event categories
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookEventCategoriesAsync()
    {
        return $this->getWebhookEventCategoriesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getWebhookEventCategoriesAsyncWithHttpInfo
     *
     * Retrieve webhook event categories
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookEventCategoriesAsyncWithHttpInfo()
    {
        $returnType = '\ultracart\v2\models\WebhookEventCategoriesResponse';
        $request = $this->getWebhookEventCategoriesRequest();
    ...
    /**
     * Create request for operation 'getWebhookEventCategories'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhookEventCategoriesRequest()
    {

        $resourcePath = '/webhook/webhook_event_categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $request_id Filter by request id (optional)
     * @param  string $begin_date Filter to deliveries on or after this date/time (optional)
     * @param  string $end_date Filter to deliveries on or before this date/time (optional)
     * @param  string $status Filter by HTTP status code (optional)
     * @param  bool $success Filter by success (true) or failure (false) (optional)
     * @param  string $event Filter by an event name contained in the delivery (optional)
     * @param  string $order_id Filter by an order id contained in the delivery (optional)
     * @param  string $request Filter by text contained in the request payload (optional)
     * @param  int $duration Filter to deliveries that took at least this many milliseconds (optional)
     ...
     */
    public function getWebhookLogSummaries($webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        list($response) = $this->getWebhookLogSummariesWithHttpInfo($webhook_oid, $request_id, $begin_date, $end_date, $status, $success, $event, $order_id, $request, $duration, $_limit, $_offset, $_since);
        return $response;
    }
     ...
     */
    public function getWebhookLogSummariesWithHttpInfo($webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        return $this->getWebhookLogSummariesWithHttpInfoRetry(true ,   $webhook_oid,   $request_id,   $begin_date,   $end_date,   $status,   $success,   $event,   $order_id,   $request,   $duration,   $_limit,   $_offset,   $_since);
    }
     ...
     * @return array of \ultracart\v2\models\WebhookLogSummariesResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse|\ultracart\v2\models\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookLogSummariesWithHttpInfoRetry($retry , $webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        $returnType = '\ultracart\v2\models\WebhookLogSummariesResponse';
        $request = $this->getWebhookLogSummariesRequest($webhook_oid, $request_id, $begin_date, $end_date, $status, $success, $event, $order_id, $request, $duration, $_limit, $_offset, $_since);
        ...
        try {
            ...
            try {
                ...
                if($e->getResponse()) {
                    ...
                    if ($statusCode == 429 && $retry && $retryAfter > 0 && $retryAfter <= $this->config->getMaxRetrySeconds()) {
                        sleep($retryAfter);
                        return $this->getWebhookLogSummariesWithHttpInfoRetry(false ,   $webhook_oid,   $request_id,   $begin_date,   $end_date,   $status,   $success,   $event,   $order_id,   $request,   $duration,   $_limit,   $_offset,   $_since);
                    }
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookLogSummariesAsync($webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        return $this->getWebhookLogSummariesAsyncWithHttpInfo($webhook_oid, $request_id, $begin_date, $end_date, $status, $success, $event, $order_id, $request, $duration, $_limit, $_offset, $_since)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookLogSummariesAsyncWithHttpInfo($webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        $returnType = '\ultracart\v2\models\WebhookLogSummariesResponse';
        $request = $this->getWebhookLogSummariesRequest($webhook_oid, $request_id, $begin_date, $end_date, $status, $success, $event, $order_id, $request, $duration, $_limit, $_offset, $_since);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhookLogSummariesRequest($webhook_oid, $request_id = null, $begin_date = null, $end_date = null, $status = null, $success = null, $event = null, $order_id = null, $request = null, $duration = null, $_limit = 100, $_offset = 0, $_since = null)
    {
        // verify the required parameter 'webhook_oid' is set
        if ($webhook_oid === null || (is_array($webhook_oid) && count($webhook_oid) === 0)) {
            throw new \InvalidArgumentException(
