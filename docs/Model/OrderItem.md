...
**discount_shipping_weight** | [**\ultracart\admin\v2\models\Weight**](Weight.md) |  | [optional] 
**distribution_center_code** | **string** | Distribution center code responsible for shipping this item | [optional] 
**edi** | [**\ultracart\admin\v2\models\OrderItemEdi**](OrderItemEdi.md) |  | [optional] 
...
**options** | [**\ultracart\admin\v2\models\OrderItemOption[]**](OrderItemOption.md) | Options | [optional] 
...
**taxable_cost** | **float** | The taxable cost of the item.  Typically the same as the cost | [optional] 
**total_cost_with_discount** | **float** | Total cost with discount | [optional] 
**total_refunded** | **float** | Total refunded on this item | [optional] 
...
**unit_cost_with_discount** | **float** | Unit cost with discount | [optional] 
