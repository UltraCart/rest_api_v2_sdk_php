...
**domestic_1_additional_cost** | **double** | Domestic 1 method additional item cost | [optional] 
**domestic_1_first_cost** | **double** | Domestic 1 method first item cost | [optional] 
**domestic_2_additional_cost** | **double** | Domestic 2 method additional item cost | [optional] 
**domestic_2_first_cost** | **double** | Domestic 2 method first item cost | [optional] 
**domestic_3_additional_cost** | **double** | Domestic 3 method additional item cost | [optional] 
**domestic_3_first_cost** | **double** | Domestic 3 method first item cost | [optional] 
**domestic_4_additional_cost** | **double** | Domestic 4 method additional item cost | [optional] 
**domestic_4_first_cost** | **double** | Domestic 4 method first item cost | [optional] 
...
**international_1_additional_cost** | **double** | International 1 method additional item cost | [optional] 
**international_1_first_cost** | **double** | International 1 method first item cost | [optional] 
**international_2_additional_cost** | **double** | International 2 method additional item cost | [optional] 
**international_2_first_cost** | **double** | International 2 method first item cost | [optional] 
**international_3_additional_cost** | **double** | International 3 method additional item cost | [optional] 
**international_3_first_cost** | **double** | International 3 method first item cost | [optional] 
**international_4_additional_cost** | **double** | International 4 method additional item cost | [optional] 
**international_4_first_cost** | **double** | International 4 method first item cost | [optional] 
...
**listing_price** | **double** | Price to list the item at | [optional] 
**listing_price_override** | **double** | The price to list the item at if different than the regular UltraCart item price | [optional] 
...
**marketplace_final_value_fee_percentage** | **double** | Marketplace FVF percentage | [optional] 
...
**marketplace_multiplier** | **double** | Marketplace multiplier | [optional] 
**marketplace_other_price** | **double** | Marketplace other price | [optional] 
**marketplace_other_seller** | **string** | Marketplace other seller | [optional] 
**marketplace_other_shipping** | **double** | Marketplace other shipping | [optional] 
**marketplace_other_total** | **double** | Marketplace other total | [optional] 
**marketplace_our_additional_profit_potential** | **double** | Marketplace our additional profit potential | [optional] 
**marketplace_our_price** | **double** | Marketplace our price | [optional] 
**marketplace_our_profit** | **double** | Marketplace our profit | [optional] 
**marketplace_our_shipping** | **double** | Marketplace our shipping | [optional] 
**marketplace_our_total** | **double** | Marketplace our total | [optional] 
**marketplace_overhead** | **double** | Marketplace overhead | [optional] 
