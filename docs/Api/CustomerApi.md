...
```php
updateCustomerEmailSuppression($customer_profile_oid, $suppression_changes): \ultracart\v2\models\CustomerEmailSuppressionResponse
```
...
------------- | ------------- | ------------- | -------------
 **customer_profile_oid** | **int**| The customer profile oid |
 **suppression_changes** | [**\ultracart\v2\models\CustomerEmailSuppressionRequest**](../Model/CustomerEmailSuppressionRequest.md)| Suppression changes |

### Return type

[**\ultracart\v2\models\CustomerEmailSuppressionResponse**](../Model/CustomerEmailSuppressionResponse.md)
