...
```php
attemptAutoOrderRebill($auto_order_oid, $_expand): \ultracart\v2\models\AutoOrderRebillResponse
```
...
[**\ultracart\v2\models\AutoOrderRebillResponse**](../Model/AutoOrderRebillResponse.md)
...
```php
cancelAutoOrderItemByReferenceOrderId($reference_order_id, $original_item_id, $_expand, $auto_order_item_cancel_request): \ultracart\v2\models\AutoOrderResponse
```
 ...
 **_expand** | **string**| The object expansion to perform on the result.  See documentation for examples | [optional]
 **auto_order_item_cancel_request** | [**\ultracart\v2\models\AutoOrderItemCancelRequest**](../Model/AutoOrderItemCancelRequest.md)| Cancel request.  Body is optional; omit for default mode&#x3D;end. | [optional]
...
```php
getAutoOrderEmails($auto_order_oid): \ultracart\v2\models\AutoOrderEmailsResponse
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **auto_order_oid** | **int**| The auto order oid to retrieve email delivery information for. |

### Return type

[**\ultracart\v2\models\AutoOrderEmailsResponse**](../Model/AutoOrderEmailsResponse.md)
...
```php
updateAutoOrderItemAddOns($auto_order_oid, $auto_order_item_oid, $auto_order_add_ons_update_request, $_expand): \ultracart\v2\models\AutoOrderResponse
```
...
```php
updateAutoOrderItemProperties($auto_order_oid, $auto_order_item_oid, $auto_order_properties_update_request, $_expand): \ultracart\v2\models\AutoOrderResponse
```
...
```php
updateAutoOrderPayment($auto_order_oid, $auto_order_payment_update_request, $_expand): \ultracart\v2\models\AutoOrderRebillResponse
```
 ...
 **auto_order_payment_update_request** | [**\ultracart\v2\models\AutoOrderPaymentUpdateRequest**](../Model/AutoOrderPaymentUpdateRequest.md)| Payment information to place on the auto order |
 **_expand** | **string**| The object expansion to perform on the result.  See documentation for examples | [optional]
...
```php
updateAutoOrderProperties($auto_order_oid, $auto_order_properties_update_request, $_expand): \ultracart\v2\models\AutoOrderResponse
```
