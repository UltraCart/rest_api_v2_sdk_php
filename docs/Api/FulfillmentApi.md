...
Acknowledge receipt of orders so that they are removed from the fulfillment queue.
 ...
 **order_ids** | **string[]**| Orders to acknowledge receipt of |
...
$api_instance = new ultracart\admin\v2\Api\FulfillmentApi();
$distribution_center_code = "distribution_center_code_example"; // string | Distribution center code
$inventories = array(new FulfillmentInventory()); // \ultracart\admin\v2\models\FulfillmentInventory[] | Inventory updates
...
------------- | ------------- | ------------- | -------------
 **distribution_center_code** | **string**| Distribution center code |
 **inventories** | [**\ultracart\admin\v2\models\FulfillmentInventory[]**](../Model/FulfillmentInventory.md)| Inventory updates |
