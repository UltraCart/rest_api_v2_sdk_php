...
> \ultracart\v2\models\OrderResponse refundOrderCompletely($order_id, $reject_after_refund, $skip_customer_notification, $auto_order_cancel, $manual_refund, $reverse_affiliate_transactions, $issue_store_credit, $auto_order_cancel_reason, $refund_reason, $reject_reason)
